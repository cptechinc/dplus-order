 ...
 *
 */
class CartDetailTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.CartDetailTableMap';
     ...
     */
    const OM_CLASS = '\\CartDetail';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'CartDetail';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CartDetailTableMap::COL_SESSIONID, CartDetailTableMap::COL_RECNO, CartDetailTableMap::COL_DATE, CartDetailTableMap::COL_TIME, CartDetailTableMap::COL_ORDERNO, CartDetailTableMap::COL_LINENBR, CartDetailTableMap::COL_ITEMID, CartDetailTableMap::COL_CUSTITEMID, CartDetailTableMap::COL_DESC1, CartDetailTableMap::COL_DESC2, CartDetailTableMap::COL_PRICE, CartDetailTableMap::COL_TOTALPRICE, CartDetailTableMap::COL_QTY, CartDetailTableMap::COL_QTYSHIPPED, CartDetailTableMap::COL_QTYBACKORD, CartDetailTableMap::COL_RSHIPDATE, CartDetailTableMap::COL_HASDOCUMENTS, CartDetailTableMap::COL_QTYAVAIL, CartDetailTableMap::COL_HASNOTES, CartDetailTableMap::COL_COST, CartDetailTableMap::COL_WHSE, CartDetailTableMap::COL_UOM, CartDetailTableMap::COL_SPCORD, CartDetailTableMap::COL_KITITEMFLAG, CartDetailTableMap::COL_PROMOCODE, CartDetailTableMap::COL_TAXCODE, CartDetailTableMap::COL_TAXCODEPERC, CartDetailTableMap::COL_DISCPCT, CartDetailTableMap::COL_LISTPRICE, CartDetailTableMap::COL_UOMCONV, CartDetailTableMap::COL_CATLGID, CartDetailTableMap::COL_ERRORMSG, CartDetailTableMap::COL_MINPRICE, CartDetailTableMap::COL_VENDORID, CartDetailTableMap::COL_VENDORITEMID, CartDetailTableMap::COL_PONBR, CartDetailTableMap::COL_POREF, CartDetailTableMap::COL_NSITEMGROUP, CartDetailTableMap::COL_SHIPFROMID, CartDetailTableMap::COL_ITEMTYPE, CartDetailTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CartDetailTableMap::COL_SESSIONID => 0, CartDetailTableMap::COL_RECNO => 1, CartDetailTableMap::COL_DATE => 2, CartDetailTableMap::COL_TIME => 3, CartDetailTableMap::COL_ORDERNO => 4, CartDetailTableMap::COL_LINENBR => 5, CartDetailTableMap::COL_ITEMID => 6, CartDetailTableMap::COL_CUSTITEMID => 7, CartDetailTableMap::COL_DESC1 => 8, CartDetailTableMap::COL_DESC2 => 9, CartDetailTableMap::COL_PRICE => 10, CartDetailTableMap::COL_TOTALPRICE => 11, CartDetailTableMap::COL_QTY => 12, CartDetailTableMap::COL_QTYSHIPPED => 13, CartDetailTableMap::COL_QTYBACKORD => 14, CartDetailTableMap::COL_RSHIPDATE => 15, CartDetailTableMap::COL_HASDOCUMENTS => 16, CartDetailTableMap::COL_QTYAVAIL => 17, CartDetailTableMap::COL_HASNOTES => 18, CartDetailTableMap::COL_COST => 19, CartDetailTableMap::COL_WHSE => 20, CartDetailTableMap::COL_UOM => 21, CartDetailTableMap::COL_SPCORD => 22, CartDetailTableMap::COL_KITITEMFLAG => 23, CartDetailTableMap::COL_PROMOCODE => 24, CartDetailTableMap::COL_TAXCODE => 25, CartDetailTableMap::COL_TAXCODEPERC => 26, CartDetailTableMap::COL_DISCPCT => 27, CartDetailTableMap::COL_LISTPRICE => 28, CartDetailTableMap::COL_UOMCONV => 29, CartDetailTableMap::COL_CATLGID => 30, CartDetailTableMap::COL_ERRORMSG => 31, CartDetailTableMap::COL_MINPRICE => 32, CartDetailTableMap::COL_VENDORID => 33, CartDetailTableMap::COL_VENDORITEMID => 34, CartDetailTableMap::COL_PONBR => 35, CartDetailTableMap::COL_POREF => 36, CartDetailTableMap::COL_NSITEMGROUP => 37, CartDetailTableMap::COL_SHIPFROMID => 38, CartDetailTableMap::COL_ITEMTYPE => 39, CartDetailTableMap::COL_DUMMY => 40, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('CartDetail');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\CartDetail');
        $this->setPackage('');
     ...
     * and findPk*() calls.
     *
     * @param \CartDetail $obj A \CartDetail object.
     ...
     *
     * @param mixed $value A \CartDetail object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \CartDetail) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \CartDetail object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? CartDetailTableMap::CLASS_DEFAULT : CartDetailTableMap::OM_CLASS;
    }
     ...
     * @return array           (CartDetail object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = CartDetailTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = CartDetailTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + CartDetailTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = CartDetailTableMap::OM_CLASS;
            /** @var CartDetail $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            CartDetailTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = CartDetailTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = CartDetailTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CartDetailTableMap::COL_SESSIONID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_RECNO);
            $criteria->addSelectColumn(CartDetailTableMap::COL_DATE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_TIME);
            $criteria->addSelectColumn(CartDetailTableMap::COL_ORDERNO);
            $criteria->addSelectColumn(CartDetailTableMap::COL_LINENBR);
            $criteria->addSelectColumn(CartDetailTableMap::COL_ITEMID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_CUSTITEMID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_DESC1);
            $criteria->addSelectColumn(CartDetailTableMap::COL_DESC2);
            $criteria->addSelectColumn(CartDetailTableMap::COL_PRICE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_TOTALPRICE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_QTY);
            $criteria->addSelectColumn(CartDetailTableMap::COL_QTYSHIPPED);
            $criteria->addSelectColumn(CartDetailTableMap::COL_QTYBACKORD);
            $criteria->addSelectColumn(CartDetailTableMap::COL_RSHIPDATE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_HASDOCUMENTS);
            $criteria->addSelectColumn(CartDetailTableMap::COL_QTYAVAIL);
            $criteria->addSelectColumn(CartDetailTableMap::COL_HASNOTES);
            $criteria->addSelectColumn(CartDetailTableMap::COL_COST);
            $criteria->addSelectColumn(CartDetailTableMap::COL_WHSE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_UOM);
            $criteria->addSelectColumn(CartDetailTableMap::COL_SPCORD);
            $criteria->addSelectColumn(CartDetailTableMap::COL_KITITEMFLAG);
            $criteria->addSelectColumn(CartDetailTableMap::COL_PROMOCODE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_TAXCODE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_TAXCODEPERC);
            $criteria->addSelectColumn(CartDetailTableMap::COL_DISCPCT);
            $criteria->addSelectColumn(CartDetailTableMap::COL_LISTPRICE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_UOMCONV);
            $criteria->addSelectColumn(CartDetailTableMap::COL_CATLGID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_ERRORMSG);
            $criteria->addSelectColumn(CartDetailTableMap::COL_MINPRICE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_VENDORID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_VENDORITEMID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_PONBR);
            $criteria->addSelectColumn(CartDetailTableMap::COL_POREF);
            $criteria->addSelectColumn(CartDetailTableMap::COL_NSITEMGROUP);
            $criteria->addSelectColumn(CartDetailTableMap::COL_SHIPFROMID);
            $criteria->addSelectColumn(CartDetailTableMap::COL_ITEMTYPE);
            $criteria->addSelectColumn(CartDetailTableMap::COL_DUMMY);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(CartDetailTableMap::DATABASE_NAME)->getTable(CartDetailTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(CartDetailTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(CartDetailTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new CartDetailTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a CartDetail or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or CartDetail object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \CartDetail) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(CartDetailTableMap::COL_SESSIONID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(CartDetailTableMap::COL_RECNO, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = CartDetailQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            CartDetailTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                CartDetailTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return CartDetailQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a CartDetail or Criteria object.
     *
     * @param mixed               $criteria Criteria or CartDetail object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from CartDetail object
        }
...
//
CartDetailTableMap::buildTableMap();
