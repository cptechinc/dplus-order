...
class SalesHistoryTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SalesHistoryTableMap::COL_ORDERNUMBER, SalesHistoryTableMap::COL_CUSTID, SalesHistoryTableMap::COL_SHIPTOID, SalesHistoryTableMap::COL_CUSTNAME, SalesHistoryTableMap::COL_CUSTPO, SalesHistoryTableMap::COL_ORDER_DATE, SalesHistoryTableMap::COL_INVOICE_DATE, SalesHistoryTableMap::COL_SALESPERSON_1, SalesHistoryTableMap::COL_SP1LOGIN, SalesHistoryTableMap::COL_HAS_TRACKING, SalesHistoryTableMap::COL_SUBTOTAL_NONTAX, SalesHistoryTableMap::COL_TOTAL_TAX, SalesHistoryTableMap::COL_TOTAL_FREIGHT, SalesHistoryTableMap::COL_TOTAL_MISC, SalesHistoryTableMap::COL_TOTAL_ORDER, SalesHistoryTableMap::COL_HAS_DOCUMENTS, SalesHistoryTableMap::COL_HAS_NOTES, SalesHistoryTableMap::COL_DATE, SalesHistoryTableMap::COL_TIME, SalesHistoryTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SalesHistoryTableMap::COL_ORDERNUMBER => 0, SalesHistoryTableMap::COL_CUSTID => 1, SalesHistoryTableMap::COL_SHIPTOID => 2, SalesHistoryTableMap::COL_CUSTNAME => 3, SalesHistoryTableMap::COL_CUSTPO => 4, SalesHistoryTableMap::COL_ORDER_DATE => 5, SalesHistoryTableMap::COL_INVOICE_DATE => 6, SalesHistoryTableMap::COL_SALESPERSON_1 => 7, SalesHistoryTableMap::COL_SP1LOGIN => 8, SalesHistoryTableMap::COL_HAS_TRACKING => 9, SalesHistoryTableMap::COL_SUBTOTAL_NONTAX => 10, SalesHistoryTableMap::COL_TOTAL_TAX => 11, SalesHistoryTableMap::COL_TOTAL_FREIGHT => 12, SalesHistoryTableMap::COL_TOTAL_MISC => 13, SalesHistoryTableMap::COL_TOTAL_ORDER => 14, SalesHistoryTableMap::COL_HAS_DOCUMENTS => 15, SalesHistoryTableMap::COL_HAS_NOTES => 16, SalesHistoryTableMap::COL_DATE => 17, SalesHistoryTableMap::COL_TIME => 18, SalesHistoryTableMap::COL_DUMMY => 19, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_ORDERNUMBER);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_CUSTID);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_SHIPTOID);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_CUSTNAME);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_CUSTPO);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_ORDER_DATE);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_INVOICE_DATE);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_SALESPERSON_1);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_SP1LOGIN);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_HAS_TRACKING);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_SUBTOTAL_NONTAX);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_TOTAL_TAX);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_TOTAL_FREIGHT);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_TOTAL_MISC);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_TOTAL_ORDER);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_HAS_DOCUMENTS);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_HAS_NOTES);
            $criteria->addSelectColumn(SalesHistoryTableMap::COL_DATE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SalesHistoryTableMap::COL_ORDERNUMBER, (array) $values, Criteria::IN);
        }
