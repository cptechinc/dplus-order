...
class SalesOrderTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(SalesOrderTableMap::COL_ORDERNUMBER, SalesOrderTableMap::COL_STATUS, SalesOrderTableMap::COL_HOLDSTATUS, SalesOrderTableMap::COL_CUSTID, SalesOrderTableMap::COL_SHIPTOID, SalesOrderTableMap::COL_SHIPTO_NAME, SalesOrderTableMap::COL_SHIPTO_ADDRESS1, SalesOrderTableMap::COL_SHIPTO_ADDRESS2, SalesOrderTableMap::COL_SHIPTO_ADDRESS3, SalesOrderTableMap::COL_SHIPTO_ADDRESS4, SalesOrderTableMap::COL_SHIPTO_CITY, SalesOrderTableMap::COL_SHIPTO_STATE, SalesOrderTableMap::COL_SHIPTO_ZIP, SalesOrderTableMap::COL_CUSTPO, SalesOrderTableMap::COL_ORDER_DATE, SalesOrderTableMap::COL_TERMCODE, SalesOrderTableMap::COL_SHIPVIACODE, SalesOrderTableMap::COL_INVOICE_NUMBER, SalesOrderTableMap::COL_INVOICE_DATE, SalesOrderTableMap::COL_GENLEDGER_PERIOD, SalesOrderTableMap::COL_SALESPERSON_1, SalesOrderTableMap::COL_SALESPERSON_1PCT, SalesOrderTableMap::COL_SALESPERSON_2, SalesOrderTableMap::COL_SALESPERSON_2PCT, SalesOrderTableMap::COL_SALESPERSON_3, SalesOrderTableMap::COL_SALESPERSON_3PCT, SalesOrderTableMap::COL_CONTRACT_NBR, SalesOrderTableMap::COL_BATCH_NBR, SalesOrderTableMap::COL_DROPRELEASEHOLD, SalesOrderTableMap::COL_SUBTOTAL_NONTAX, SalesOrderTableMap::COL_SUBTOTAL_TAX, SalesOrderTableMap::COL_TOTAL_TAX, SalesOrderTableMap::COL_TOTAL_FREIGHT, SalesOrderTableMap::COL_TOTAL_MISC, SalesOrderTableMap::COL_TOTAL_ORDER, SalesOrderTableMap::COL_TOTAL_COST, SalesOrderTableMap::COL_LOCK, SalesOrderTableMap::COL_TAKEN_DATE, SalesOrderTableMap::COL_TAKEN_TIME, SalesOrderTableMap::COL_PICK_DATE, SalesOrderTableMap::COL_PICK_TIME, SalesOrderTableMap::COL_PACK_DATE, SalesOrderTableMap::COL_PACK_TIME, SalesOrderTableMap::COL_VERIFY_DATE, SalesOrderTableMap::COL_VERIFY_TIME, SalesOrderTableMap::COL_CREDITMEMO, SalesOrderTableMap::COL_BOOKED, SalesOrderTableMap::COL_ORIGINAL_WHSE, SalesOrderTableMap::COL_BILLTO_STATE, SalesOrderTableMap::COL_SHIPCOMPLETE, SalesOrderTableMap::COL_CWO_FLAG, SalesOrderTableMap::COL_DIVISION, SalesOrderTableMap::COL_TAKEN_CODE, SalesOrderTableMap::COL_PACK_CODE, SalesOrderTableMap::COL_PICK_CODE, SalesOrderTableMap::COL_VERIFY_CODE, SalesOrderTableMap::COL_TOTAL_DISCOUNT, SalesOrderTableMap::COL_EDI_REFERERENCENBR, SalesOrderTableMap::COL_USER_CODE1, SalesOrderTableMap::COL_USER_CODE2, SalesOrderTableMap::COL_USER_CODE3, SalesOrderTableMap::COL_USER_CODE4, SalesOrderTableMap::COL_EXCHANGE_COUNTRY, SalesOrderTableMap::COL_EXCHANGE_RATE, SalesOrderTableMap::COL_WEIGHT_TOTAL, SalesOrderTableMap::COL_WEIGHT_OVERRIDE, SalesOrderTableMap::COL_BOX_COUNT, SalesOrderTableMap::COL_REQUEST_DATE, SalesOrderTableMap::COL_CANCEL_DATE, SalesOrderTableMap::COL_LOCKEDBY, SalesOrderTableMap::COL_RELEASE_NUMBER, SalesOrderTableMap::COL_WHSE, SalesOrderTableMap::COL_BACKORDER_DATE, SalesOrderTableMap::COL_DEPTCODE, SalesOrderTableMap::COL_FREIGHT_IN_ENTERED, SalesOrderTableMap::COL_DROPSHIP_ENTERED, SalesOrderTableMap::COL_ER_FLAG, SalesOrderTableMap::COL_FREIGHT_IN, SalesOrderTableMap::COL_DROPSHIP, SalesOrderTableMap::COL_MINORDER, SalesOrderTableMap::COL_CONTRACT_TERMS, SalesOrderTableMap::COL_DROPSHIP_BILLED, SalesOrderTableMap::COL_ORDER_TYPE, SalesOrderTableMap::COL_TRACKING_EDINUMBER, SalesOrderTableMap::COL_SOURCE, SalesOrderTableMap::COL_PICK_FORMAT, SalesOrderTableMap::COL_INVOICE_FORMAT, SalesOrderTableMap::COL_CASH_AMOUNT, SalesOrderTableMap::COL_CHECK_AMOUNT, SalesOrderTableMap::COL_CHECK_NUMBER, SalesOrderTableMap::COL_DEPOSIT_AMOUNT, SalesOrderTableMap::COL_DEPOSIT_NUMBER, SalesOrderTableMap::COL_ORIGINAL_SUBTOTAL_TAX, SalesOrderTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX, SalesOrderTableMap::COL_ORIGINAL_TOTAL_TAX, SalesOrderTableMap::COL_ORIGINAL_TOTAL, SalesOrderTableMap::COL_PICK_PRINTDATE, SalesOrderTableMap::COL_PICK_PRINTTIME, SalesOrderTableMap::COL_CONTACT, SalesOrderTableMap::COL_PHONE_INTL, SalesOrderTableMap::COL_PHONE_ACCESSCODE, SalesOrderTableMap::COL_PHONE_COUNTRYCODE, SalesOrderTableMap::COL_PHONE, SalesOrderTableMap::COL_PHONE_EXT, SalesOrderTableMap::COL_FAX_INTL, SalesOrderTableMap::COL_FAX_ACCESSCODE, SalesOrderTableMap::COL_FAX_COUNTRYCODE, SalesOrderTableMap::COL_FAX, SalesOrderTableMap::COL_SHIP_ACCOUNT, SalesOrderTableMap::COL_CHANGE_DUE, SalesOrderTableMap::COL_DISCOUNT_ADDITIONAL, SalesOrderTableMap::COL_ALL_SHIP, SalesOrderTableMap::COL_CREDIT_APPLIED, SalesOrderTableMap::COL_INVOICE_PRINTDATE, SalesOrderTableMap::COL_INVOICE_PRINTTIME, SalesOrderTableMap::COL_DISCOUNT_FREIGHT, SalesOrderTableMap::COL_SHIP_COMPLETEOVERRIDE, SalesOrderTableMap::COL_CONTACT_EMAIL, SalesOrderTableMap::COL_MANUAL_FREIGHT, SalesOrderTableMap::COL_INTERNAL_FREIGHT, SalesOrderTableMap::COL_COST_FREIGHT, SalesOrderTableMap::COL_ROUTE, SalesOrderTableMap::COL_ROUTE_SEQ, SalesOrderTableMap::COL_EDI_855SENT, SalesOrderTableMap::COL_FREIGHT_3RDPARTY, SalesOrderTableMap::COL_FOB, SalesOrderTableMap::COL_CONFIRM_IMAGE, SalesOrderTableMap::COL_CSTK_CONSIGN, SalesOrderTableMap::COL_MANUFACTURER, SalesOrderTableMap::COL_PICK_QUEUE, SalesOrderTableMap::COL_ARRIVE_DATE, SalesOrderTableMap::COL_SURCHARGE_STATUS, SalesOrderTableMap::COL_FREIGHT_GROUP, SalesOrderTableMap::COL_COMM_OVERRIDE, SalesOrderTableMap::COL_CHARGE_SPLIT, SalesOrderTableMap::COL_CREDITCART_APPROVED, SalesOrderTableMap::COL_ORIGINAL_ORDERNUMBER, SalesOrderTableMap::COL_HAS_NOTES, SalesOrderTableMap::COL_HAS_DOCUMENTS, SalesOrderTableMap::COL_HAS_TRACKING, SalesOrderTableMap::COL_DATE, SalesOrderTableMap::COL_TIME, SalesOrderTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(SalesOrderTableMap::COL_ORDERNUMBER => 0, SalesOrderTableMap::COL_STATUS => 1, SalesOrderTableMap::COL_HOLDSTATUS => 2, SalesOrderTableMap::COL_CUSTID => 3, SalesOrderTableMap::COL_SHIPTOID => 4, SalesOrderTableMap::COL_SHIPTO_NAME => 5, SalesOrderTableMap::COL_SHIPTO_ADDRESS1 => 6, SalesOrderTableMap::COL_SHIPTO_ADDRESS2 => 7, SalesOrderTableMap::COL_SHIPTO_ADDRESS3 => 8, SalesOrderTableMap::COL_SHIPTO_ADDRESS4 => 9, SalesOrderTableMap::COL_SHIPTO_CITY => 10, SalesOrderTableMap::COL_SHIPTO_STATE => 11, SalesOrderTableMap::COL_SHIPTO_ZIP => 12, SalesOrderTableMap::COL_CUSTPO => 13, SalesOrderTableMap::COL_ORDER_DATE => 14, SalesOrderTableMap::COL_TERMCODE => 15, SalesOrderTableMap::COL_SHIPVIACODE => 16, SalesOrderTableMap::COL_INVOICE_NUMBER => 17, SalesOrderTableMap::COL_INVOICE_DATE => 18, SalesOrderTableMap::COL_GENLEDGER_PERIOD => 19, SalesOrderTableMap::COL_SALESPERSON_1 => 20, SalesOrderTableMap::COL_SALESPERSON_1PCT => 21, SalesOrderTableMap::COL_SALESPERSON_2 => 22, SalesOrderTableMap::COL_SALESPERSON_2PCT => 23, SalesOrderTableMap::COL_SALESPERSON_3 => 24, SalesOrderTableMap::COL_SALESPERSON_3PCT => 25, SalesOrderTableMap::COL_CONTRACT_NBR => 26, SalesOrderTableMap::COL_BATCH_NBR => 27, SalesOrderTableMap::COL_DROPRELEASEHOLD => 28, SalesOrderTableMap::COL_SUBTOTAL_NONTAX => 29, SalesOrderTableMap::COL_SUBTOTAL_TAX => 30, SalesOrderTableMap::COL_TOTAL_TAX => 31, SalesOrderTableMap::COL_TOTAL_FREIGHT => 32, SalesOrderTableMap::COL_TOTAL_MISC => 33, SalesOrderTableMap::COL_TOTAL_ORDER => 34, SalesOrderTableMap::COL_TOTAL_COST => 35, SalesOrderTableMap::COL_LOCK => 36, SalesOrderTableMap::COL_TAKEN_DATE => 37, SalesOrderTableMap::COL_TAKEN_TIME => 38, SalesOrderTableMap::COL_PICK_DATE => 39, SalesOrderTableMap::COL_PICK_TIME => 40, SalesOrderTableMap::COL_PACK_DATE => 41, SalesOrderTableMap::COL_PACK_TIME => 42, SalesOrderTableMap::COL_VERIFY_DATE => 43, SalesOrderTableMap::COL_VERIFY_TIME => 44, SalesOrderTableMap::COL_CREDITMEMO => 45, SalesOrderTableMap::COL_BOOKED => 46, SalesOrderTableMap::COL_ORIGINAL_WHSE => 47, SalesOrderTableMap::COL_BILLTO_STATE => 48, SalesOrderTableMap::COL_SHIPCOMPLETE => 49, SalesOrderTableMap::COL_CWO_FLAG => 50, SalesOrderTableMap::COL_DIVISION => 51, SalesOrderTableMap::COL_TAKEN_CODE => 52, SalesOrderTableMap::COL_PACK_CODE => 53, SalesOrderTableMap::COL_PICK_CODE => 54, SalesOrderTableMap::COL_VERIFY_CODE => 55, SalesOrderTableMap::COL_TOTAL_DISCOUNT => 56, SalesOrderTableMap::COL_EDI_REFERERENCENBR => 57, SalesOrderTableMap::COL_USER_CODE1 => 58, SalesOrderTableMap::COL_USER_CODE2 => 59, SalesOrderTableMap::COL_USER_CODE3 => 60, SalesOrderTableMap::COL_USER_CODE4 => 61, SalesOrderTableMap::COL_EXCHANGE_COUNTRY => 62, SalesOrderTableMap::COL_EXCHANGE_RATE => 63, SalesOrderTableMap::COL_WEIGHT_TOTAL => 64, SalesOrderTableMap::COL_WEIGHT_OVERRIDE => 65, SalesOrderTableMap::COL_BOX_COUNT => 66, SalesOrderTableMap::COL_REQUEST_DATE => 67, SalesOrderTableMap::COL_CANCEL_DATE => 68, SalesOrderTableMap::COL_LOCKEDBY => 69, SalesOrderTableMap::COL_RELEASE_NUMBER => 70, SalesOrderTableMap::COL_WHSE => 71, SalesOrderTableMap::COL_BACKORDER_DATE => 72, SalesOrderTableMap::COL_DEPTCODE => 73, SalesOrderTableMap::COL_FREIGHT_IN_ENTERED => 74, SalesOrderTableMap::COL_DROPSHIP_ENTERED => 75, SalesOrderTableMap::COL_ER_FLAG => 76, SalesOrderTableMap::COL_FREIGHT_IN => 77, SalesOrderTableMap::COL_DROPSHIP => 78, SalesOrderTableMap::COL_MINORDER => 79, SalesOrderTableMap::COL_CONTRACT_TERMS => 80, SalesOrderTableMap::COL_DROPSHIP_BILLED => 81, SalesOrderTableMap::COL_ORDER_TYPE => 82, SalesOrderTableMap::COL_TRACKING_EDINUMBER => 83, SalesOrderTableMap::COL_SOURCE => 84, SalesOrderTableMap::COL_PICK_FORMAT => 85, SalesOrderTableMap::COL_INVOICE_FORMAT => 86, SalesOrderTableMap::COL_CASH_AMOUNT => 87, SalesOrderTableMap::COL_CHECK_AMOUNT => 88, SalesOrderTableMap::COL_CHECK_NUMBER => 89, SalesOrderTableMap::COL_DEPOSIT_AMOUNT => 90, SalesOrderTableMap::COL_DEPOSIT_NUMBER => 91, SalesOrderTableMap::COL_ORIGINAL_SUBTOTAL_TAX => 92, SalesOrderTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX => 93, SalesOrderTableMap::COL_ORIGINAL_TOTAL_TAX => 94, SalesOrderTableMap::COL_ORIGINAL_TOTAL => 95, SalesOrderTableMap::COL_PICK_PRINTDATE => 96, SalesOrderTableMap::COL_PICK_PRINTTIME => 97, SalesOrderTableMap::COL_CONTACT => 98, SalesOrderTableMap::COL_PHONE_INTL => 99, SalesOrderTableMap::COL_PHONE_ACCESSCODE => 100, SalesOrderTableMap::COL_PHONE_COUNTRYCODE => 101, SalesOrderTableMap::COL_PHONE => 102, SalesOrderTableMap::COL_PHONE_EXT => 103, SalesOrderTableMap::COL_FAX_INTL => 104, SalesOrderTableMap::COL_FAX_ACCESSCODE => 105, SalesOrderTableMap::COL_FAX_COUNTRYCODE => 106, SalesOrderTableMap::COL_FAX => 107, SalesOrderTableMap::COL_SHIP_ACCOUNT => 108, SalesOrderTableMap::COL_CHANGE_DUE => 109, SalesOrderTableMap::COL_DISCOUNT_ADDITIONAL => 110, SalesOrderTableMap::COL_ALL_SHIP => 111, SalesOrderTableMap::COL_CREDIT_APPLIED => 112, SalesOrderTableMap::COL_INVOICE_PRINTDATE => 113, SalesOrderTableMap::COL_INVOICE_PRINTTIME => 114, SalesOrderTableMap::COL_DISCOUNT_FREIGHT => 115, SalesOrderTableMap::COL_SHIP_COMPLETEOVERRIDE => 116, SalesOrderTableMap::COL_CONTACT_EMAIL => 117, SalesOrderTableMap::COL_MANUAL_FREIGHT => 118, SalesOrderTableMap::COL_INTERNAL_FREIGHT => 119, SalesOrderTableMap::COL_COST_FREIGHT => 120, SalesOrderTableMap::COL_ROUTE => 121, SalesOrderTableMap::COL_ROUTE_SEQ => 122, SalesOrderTableMap::COL_EDI_855SENT => 123, SalesOrderTableMap::COL_FREIGHT_3RDPARTY => 124, SalesOrderTableMap::COL_FOB => 125, SalesOrderTableMap::COL_CONFIRM_IMAGE => 126, SalesOrderTableMap::COL_CSTK_CONSIGN => 127, SalesOrderTableMap::COL_MANUFACTURER => 128, SalesOrderTableMap::COL_PICK_QUEUE => 129, SalesOrderTableMap::COL_ARRIVE_DATE => 130, SalesOrderTableMap::COL_SURCHARGE_STATUS => 131, SalesOrderTableMap::COL_FREIGHT_GROUP => 132, SalesOrderTableMap::COL_COMM_OVERRIDE => 133, SalesOrderTableMap::COL_CHARGE_SPLIT => 134, SalesOrderTableMap::COL_CREDITCART_APPROVED => 135, SalesOrderTableMap::COL_ORIGINAL_ORDERNUMBER => 136, SalesOrderTableMap::COL_HAS_NOTES => 137, SalesOrderTableMap::COL_HAS_DOCUMENTS => 138, SalesOrderTableMap::COL_HAS_TRACKING => 139, SalesOrderTableMap::COL_DATE => 140, SalesOrderTableMap::COL_TIME => 141, SalesOrderTableMap::COL_DUMMY => 142, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORDERNUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_STATUS);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_HOLDSTATUS);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CUSTID);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTOID);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_NAME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_ADDRESS1);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_ADDRESS2);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_ADDRESS3);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_ADDRESS4);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_CITY);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_STATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPTO_ZIP);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CUSTPO);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORDER_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TERMCODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPVIACODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_INVOICE_NUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_INVOICE_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_GENLEDGER_PERIOD);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SALESPERSON_1);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SALESPERSON_1PCT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SALESPERSON_2);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SALESPERSON_2PCT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SALESPERSON_3);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SALESPERSON_3PCT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CONTRACT_NBR);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_BATCH_NBR);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DROPRELEASEHOLD);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SUBTOTAL_NONTAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SUBTOTAL_TAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TOTAL_TAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TOTAL_FREIGHT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TOTAL_MISC);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TOTAL_ORDER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TOTAL_COST);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_LOCK);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TAKEN_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TAKEN_TIME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_TIME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PACK_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PACK_TIME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_VERIFY_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_VERIFY_TIME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CREDITMEMO);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_BOOKED);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORIGINAL_WHSE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_BILLTO_STATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIPCOMPLETE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CWO_FLAG);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DIVISION);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TAKEN_CODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PACK_CODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_CODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_VERIFY_CODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TOTAL_DISCOUNT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_EDI_REFERERENCENBR);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_USER_CODE1);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_USER_CODE2);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_USER_CODE3);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_USER_CODE4);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_EXCHANGE_COUNTRY);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_EXCHANGE_RATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_WEIGHT_TOTAL);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_WEIGHT_OVERRIDE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_BOX_COUNT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_REQUEST_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CANCEL_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_LOCKEDBY);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_RELEASE_NUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_WHSE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_BACKORDER_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DEPTCODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FREIGHT_IN_ENTERED);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DROPSHIP_ENTERED);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ER_FLAG);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FREIGHT_IN);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DROPSHIP);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_MINORDER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CONTRACT_TERMS);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DROPSHIP_BILLED);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORDER_TYPE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TRACKING_EDINUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SOURCE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_FORMAT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_INVOICE_FORMAT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CASH_AMOUNT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CHECK_AMOUNT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CHECK_NUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DEPOSIT_AMOUNT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DEPOSIT_NUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORIGINAL_SUBTOTAL_TAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORIGINAL_TOTAL_TAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORIGINAL_TOTAL);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_PRINTDATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_PRINTTIME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CONTACT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PHONE_INTL);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PHONE_ACCESSCODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PHONE_COUNTRYCODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PHONE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PHONE_EXT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FAX_INTL);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FAX_ACCESSCODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FAX_COUNTRYCODE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FAX);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIP_ACCOUNT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CHANGE_DUE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DISCOUNT_ADDITIONAL);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ALL_SHIP);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CREDIT_APPLIED);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_INVOICE_PRINTDATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_INVOICE_PRINTTIME);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DISCOUNT_FREIGHT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SHIP_COMPLETEOVERRIDE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CONTACT_EMAIL);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_MANUAL_FREIGHT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_INTERNAL_FREIGHT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_COST_FREIGHT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ROUTE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ROUTE_SEQ);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_EDI_855SENT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FREIGHT_3RDPARTY);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FOB);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CONFIRM_IMAGE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CSTK_CONSIGN);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_MANUFACTURER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_PICK_QUEUE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ARRIVE_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_SURCHARGE_STATUS);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_FREIGHT_GROUP);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_COMM_OVERRIDE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CHARGE_SPLIT);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_CREDITCART_APPROVED);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_ORIGINAL_ORDERNUMBER);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_HAS_NOTES);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_HAS_DOCUMENTS);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_HAS_TRACKING);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_DATE);
            $criteria->addSelectColumn(SalesOrderTableMap::COL_TIME);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(SalesOrderTableMap::COL_ORDERNUMBER, (array) $values, Criteria::IN);
        }
