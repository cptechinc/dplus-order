...
class QuoteDetailTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(QuoteDetailTableMap::COL_SESSIONID, QuoteDetailTableMap::COL_RECNO, QuoteDetailTableMap::COL_DATE, QuoteDetailTableMap::COL_TIME, QuoteDetailTableMap::COL_QUOTENBR, QuoteDetailTableMap::COL_CUSTID, QuoteDetailTableMap::COL_LINENBR, QuoteDetailTableMap::COL_SUBLINENBR, QuoteDetailTableMap::COL_ITEMID, QuoteDetailTableMap::COL_DESC1, QuoteDetailTableMap::COL_DESC2, QuoteDetailTableMap::COL_CUSTITEMID, QuoteDetailTableMap::COL_VENDORID, QuoteDetailTableMap::COL_VENDORITEMID, QuoteDetailTableMap::COL_STATUS, QuoteDetailTableMap::COL_LOSTREASON, QuoteDetailTableMap::COL_LOSTDATE, QuoteDetailTableMap::COL_KITITEMFLAG, QuoteDetailTableMap::COL_HASNOTES, QuoteDetailTableMap::COL_VENDDETAIL, QuoteDetailTableMap::COL_RSHIPDATE, QuoteDetailTableMap::COL_LEADDAYS, QuoteDetailTableMap::COL_TAXCODE, QuoteDetailTableMap::COL_ORDRQTY, QuoteDetailTableMap::COL_ORDRPRICE, QuoteDetailTableMap::COL_ORDRCOST, QuoteDetailTableMap::COL_ORDRTOTALPRICE, QuoteDetailTableMap::COL_ORDRTOTALCOST, QuoteDetailTableMap::COL_UOM, QuoteDetailTableMap::COL_COSTUOM, QuoteDetailTableMap::COL_WHSE, QuoteDetailTableMap::COL_LISTPRICE, QuoteDetailTableMap::COL_STANCOST, QuoteDetailTableMap::COL_QUOTIND, QuoteDetailTableMap::COL_QUOTQTY, QuoteDetailTableMap::COL_QUOTPRICE, QuoteDetailTableMap::COL_QUOTCOST, QuoteDetailTableMap::COL_QUOTMKUPMARG, QuoteDetailTableMap::COL_DISCPCT, QuoteDetailTableMap::COL_SPCORD, QuoteDetailTableMap::COL_ERROR, QuoteDetailTableMap::COL_ERRORMSG, QuoteDetailTableMap::COL_MINPRICE, QuoteDetailTableMap::COL_NSITEMGROUP, QuoteDetailTableMap::COL_SHIPFROMID, QuoteDetailTableMap::COL_ITEMTYPE, QuoteDetailTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(QuoteDetailTableMap::COL_SESSIONID => 0, QuoteDetailTableMap::COL_RECNO => 1, QuoteDetailTableMap::COL_DATE => 2, QuoteDetailTableMap::COL_TIME => 3, QuoteDetailTableMap::COL_QUOTENBR => 4, QuoteDetailTableMap::COL_CUSTID => 5, QuoteDetailTableMap::COL_LINENBR => 6, QuoteDetailTableMap::COL_SUBLINENBR => 7, QuoteDetailTableMap::COL_ITEMID => 8, QuoteDetailTableMap::COL_DESC1 => 9, QuoteDetailTableMap::COL_DESC2 => 10, QuoteDetailTableMap::COL_CUSTITEMID => 11, QuoteDetailTableMap::COL_VENDORID => 12, QuoteDetailTableMap::COL_VENDORITEMID => 13, QuoteDetailTableMap::COL_STATUS => 14, QuoteDetailTableMap::COL_LOSTREASON => 15, QuoteDetailTableMap::COL_LOSTDATE => 16, QuoteDetailTableMap::COL_KITITEMFLAG => 17, QuoteDetailTableMap::COL_HASNOTES => 18, QuoteDetailTableMap::COL_VENDDETAIL => 19, QuoteDetailTableMap::COL_RSHIPDATE => 20, QuoteDetailTableMap::COL_LEADDAYS => 21, QuoteDetailTableMap::COL_TAXCODE => 22, QuoteDetailTableMap::COL_ORDRQTY => 23, QuoteDetailTableMap::COL_ORDRPRICE => 24, QuoteDetailTableMap::COL_ORDRCOST => 25, QuoteDetailTableMap::COL_ORDRTOTALPRICE => 26, QuoteDetailTableMap::COL_ORDRTOTALCOST => 27, QuoteDetailTableMap::COL_UOM => 28, QuoteDetailTableMap::COL_COSTUOM => 29, QuoteDetailTableMap::COL_WHSE => 30, QuoteDetailTableMap::COL_LISTPRICE => 31, QuoteDetailTableMap::COL_STANCOST => 32, QuoteDetailTableMap::COL_QUOTIND => 33, QuoteDetailTableMap::COL_QUOTQTY => 34, QuoteDetailTableMap::COL_QUOTPRICE => 35, QuoteDetailTableMap::COL_QUOTCOST => 36, QuoteDetailTableMap::COL_QUOTMKUPMARG => 37, QuoteDetailTableMap::COL_DISCPCT => 38, QuoteDetailTableMap::COL_SPCORD => 39, QuoteDetailTableMap::COL_ERROR => 40, QuoteDetailTableMap::COL_ERRORMSG => 41, QuoteDetailTableMap::COL_MINPRICE => 42, QuoteDetailTableMap::COL_NSITEMGROUP => 43, QuoteDetailTableMap::COL_SHIPFROMID => 44, QuoteDetailTableMap::COL_ITEMTYPE => 45, QuoteDetailTableMap::COL_DUMMY => 46, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_SESSIONID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_RECNO);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_DATE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_TIME);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_QUOTENBR);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_CUSTID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_LINENBR);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_SUBLINENBR);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ITEMID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_DESC1);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_DESC2);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_CUSTITEMID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_VENDORID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_VENDORITEMID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_STATUS);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_LOSTREASON);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_LOSTDATE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_KITITEMFLAG);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_HASNOTES);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_VENDDETAIL);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_RSHIPDATE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_LEADDAYS);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_TAXCODE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ORDRQTY);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ORDRPRICE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ORDRCOST);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ORDRTOTALPRICE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ORDRTOTALCOST);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_UOM);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_COSTUOM);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_WHSE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_LISTPRICE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_STANCOST);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_QUOTIND);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_QUOTQTY);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_QUOTPRICE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_QUOTCOST);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_QUOTMKUPMARG);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_DISCPCT);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_SPCORD);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ERROR);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ERRORMSG);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_MINPRICE);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_NSITEMGROUP);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_SHIPFROMID);
            $criteria->addSelectColumn(QuoteDetailTableMap::COL_ITEMTYPE);
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(QuoteDetailTableMap::COL_SESSIONID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(QuoteDetailTableMap::COL_RECNO, $value[1]));
