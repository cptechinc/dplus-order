...
abstract class SalesOrderDetail implements ActiveRecordInterface
{
    ...
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecno($v)
    {
        ...
        if ($this->recno !== $v) {
            $this->recno = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_RECNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_TIME] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_TYPE] = true;
        }
    ...
    public function setOrderno($v)
    {
        ...
        if ($this->orderno !== $v) {
            $this->orderno = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_ORDERNO] = true;
        }
    ...
    public function setLinenbr($v)
    {
        ...
        if ($this->linenbr !== $v) {
            $this->linenbr = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_LINENBR] = true;
        }
    ...
    public function setSublinenbr($v)
    {
        ...
        if ($this->sublinenbr !== $v) {
            $this->sublinenbr = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_SUBLINENBR] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_ITEMID] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_CUSTID] = true;
        }
    ...
    public function setCustitemid($v)
    {
        ...
        if ($this->custitemid !== $v) {
            $this->custitemid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_CUSTITEMID] = true;
        }
    ...
    public function setDesc1($v)
    {
        ...
        if ($this->desc1 !== $v) {
            $this->desc1 = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_DESC1] = true;
        }
    ...
    public function setDesc2($v)
    {
        ...
        if ($this->desc2 !== $v) {
            $this->desc2 = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_DESC2] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_PRICE] = true;
        }
    ...
    public function setTotalprice($v)
    {
        ...
        if ($this->totalprice !== $v) {
            $this->totalprice = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_TOTALPRICE] = true;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QTY] = true;
        }
    ...
    public function setQtyshipped($v)
    {
        ...
        if ($this->qtyshipped !== $v) {
            $this->qtyshipped = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QTYSHIPPED] = true;
        }
    ...
    public function setQtybackord($v)
    {
        ...
        if ($this->qtybackord !== $v) {
            $this->qtybackord = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QTYBACKORD] = true;
        }
    ...
    public function setRshipdate($v)
    {
        ...
        if ($this->rshipdate !== $v) {
            $this->rshipdate = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_RSHIPDATE] = true;
        }
    ...
    public function setHasdocuments($v)
    {
        ...
        if ($this->hasdocuments !== $v) {
            $this->hasdocuments = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_HASDOCUMENTS] = true;
        }
    ...
    public function setQtyavail($v)
    {
        ...
        if ($this->qtyavail !== $v) {
            $this->qtyavail = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QTYAVAIL] = true;
        }
    ...
    public function setHasnotes($v)
    {
        ...
        if ($this->hasnotes !== $v) {
            $this->hasnotes = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_HASNOTES] = true;
        }
    ...
    public function setCost($v)
    {
        ...
        if ($this->cost !== $v) {
            $this->cost = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_COST] = true;
        }
    ...
    public function setWhse($v)
    {
        ...
        if ($this->whse !== $v) {
            $this->whse = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_WHSE] = true;
        }
    ...
    public function setUom($v)
    {
        ...
        if ($this->uom !== $v) {
            $this->uom = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_UOM] = true;
        }
    ...
    public function setSpcord($v)
    {
        ...
        if ($this->spcord !== $v) {
            $this->spcord = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_SPCORD] = true;
        }
    ...
    public function setKititemflag($v)
    {
        ...
        if ($this->kititemflag !== $v) {
            $this->kititemflag = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_KITITEMFLAG] = true;
        }
    ...
    public function setPromocode($v)
    {
        ...
        if ($this->promocode !== $v) {
            $this->promocode = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_PROMOCODE] = true;
        }
    ...
    public function setTaxcode($v)
    {
        ...
        if ($this->taxcode !== $v) {
            $this->taxcode = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_TAXCODE] = true;
        }
    ...
    public function setTaxcodeperc($v)
    {
        ...
        if ($this->taxcodeperc !== $v) {
            $this->taxcodeperc = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_TAXCODEPERC] = true;
        }
    ...
    public function setDiscpct($v)
    {
        ...
        if ($this->discpct !== $v) {
            $this->discpct = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_DISCPCT] = true;
        }
    ...
    public function setListprice($v)
    {
        ...
        if ($this->listprice !== $v) {
            $this->listprice = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_LISTPRICE] = true;
        }
    ...
    public function setUomconv($v)
    {
        ...
        if ($this->uomconv !== $v) {
            $this->uomconv = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_UOMCONV] = true;
        }
    ...
    public function setVendorid($v)
    {
        ...
        if ($this->vendorid !== $v) {
            $this->vendorid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_VENDORID] = true;
        }
    ...
    public function setVendoritemid($v)
    {
        ...
        if ($this->vendoritemid !== $v) {
            $this->vendoritemid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_VENDORITEMID] = true;
        }
    ...
    public function setMfgid($v)
    {
        ...
        if ($this->mfgid !== $v) {
            $this->mfgid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_MFGID] = true;
        }
    ...
    public function setMfgitemid($v)
    {
        ...
        if ($this->mfgitemid !== $v) {
            $this->mfgitemid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_MFGITEMID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_STATUS] = true;
        }
    ...
    public function setLostreason($v)
    {
        ...
        if ($this->lostreason !== $v) {
            $this->lostreason = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_LOSTREASON] = true;
        }
    ...
    public function setLostdate($v)
    {
        ...
        if ($this->lostdate !== $v) {
            $this->lostdate = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_LOSTDATE] = true;
        }
    ...
    public function setNotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_NOTES] = true;
        }
    ...
    public function setLeaddays($v)
    {
        ...
        if ($this->leaddays !== $v) {
            $this->leaddays = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_LEADDAYS] = true;
        }
    ...
    public function setOrdrtotalcost($v)
    {
        ...
        if ($this->ordrtotalcost !== $v) {
            ...
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_ORDRTOTALCOST] = true;
        }
    ...
    public function setCostuom($v)
    {
        ...
        if ($this->costuom !== $v) {
            $this->costuom = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_COSTUOM] = true;
        }
    ...
    public function setStancost($v)
    {
        ...
        if ($this->stancost !== $v) {
            $this->stancost = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_STANCOST] = true;
        }
    ...
    public function setQuotind($v)
    {
        ...
        if ($this->quotind !== $v) {
            $this->quotind = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QUOTIND] = true;
        }
    ...
    public function setQuotqty($v)
    {
        ...
        if ($this->quotqty !== $v) {
            $this->quotqty = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QUOTQTY] = true;
        }
    ...
    public function setQuotprice($v)
    {
        ...
        if ($this->quotprice !== $v) {
            $this->quotprice = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QUOTPRICE] = true;
        }
    ...
    public function setQuotcost($v)
    {
        ...
        if ($this->quotcost !== $v) {
            $this->quotcost = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QUOTCOST] = true;
        }
    ...
    public function setQuotmkupmarg($v)
    {
        ...
        if ($this->quotmkupmarg !== $v) {
            $this->quotmkupmarg = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QUOTMKUPMARG] = true;
        }
    ...
    public function setQuotdiscpct($v)
    {
        ...
        if ($this->quotdiscpct !== $v) {
            $this->quotdiscpct = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_QUOTDISCPCT] = true;
        }
    ...
    public function setErrormsg($v)
    {
        ...
        if ($this->errormsg !== $v) {
            $this->errormsg = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_ERRORMSG] = true;
        }
    ...
    public function setMinprice($v)
    {
        ...
        if ($this->minprice !== $v) {
            $this->minprice = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_MINPRICE] = true;
        }
    ...
    public function setPonbr($v)
    {
        ...
        if ($this->ponbr !== $v) {
            $this->ponbr = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_PONBR] = true;
        }
    ...
    public function setPoref($v)
    {
        ...
        if ($this->poref !== $v) {
            $this->poref = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_POREF] = true;
        }
    ...
    public function setNsitemgroup($v)
    {
        ...
        if ($this->nsitemgroup !== $v) {
            $this->nsitemgroup = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_NSITEMGROUP] = true;
        }
    ...
    public function setShipfromid($v)
    {
        ...
        if ($this->shipfromid !== $v) {
            $this->shipfromid = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_SHIPFROMID] = true;
        }
    ...
    public function setItemtype($v)
    {
        ...
        if ($this->itemtype !== $v) {
            $this->itemtype = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_ITEMTYPE] = true;
        }
    ...
    public function setCanbackorder($v)
    {
        ...
        if ($this->canbackorder !== $v) {
            $this->canbackorder = $v;
            $this->modifiedColumns[SalesOrderDetailTableMap::COL_CANBACKORDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SalesOrderDetailTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SalesOrderDetailTableMap::translateFieldName('Recno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SalesOrderDetailTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SalesOrderDetailTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SalesOrderDetailTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SalesOrderDetailTableMap::translateFieldName('Orderno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SalesOrderDetailTableMap::translateFieldName('Linenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->linenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SalesOrderDetailTableMap::translateFieldName('Sublinenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sublinenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SalesOrderDetailTableMap::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SalesOrderDetailTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SalesOrderDetailTableMap::translateFieldName('Custitemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custitemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SalesOrderDetailTableMap::translateFieldName('Desc1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SalesOrderDetailTableMap::translateFieldName('Desc2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SalesOrderDetailTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : SalesOrderDetailTableMap::translateFieldName('Totalprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : SalesOrderDetailTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qty = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SalesOrderDetailTableMap::translateFieldName('Qtyshipped', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtyshipped = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SalesOrderDetailTableMap::translateFieldName('Qtybackord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtybackord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : SalesOrderDetailTableMap::translateFieldName('Rshipdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rshipdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : SalesOrderDetailTableMap::translateFieldName('Hasdocuments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasdocuments = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : SalesOrderDetailTableMap::translateFieldName('Qtyavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtyavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : SalesOrderDetailTableMap::translateFieldName('Hasnotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasnotes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : SalesOrderDetailTableMap::translateFieldName('Cost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : SalesOrderDetailTableMap::translateFieldName('Whse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : SalesOrderDetailTableMap::translateFieldName('Uom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : SalesOrderDetailTableMap::translateFieldName('Spcord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->spcord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : SalesOrderDetailTableMap::translateFieldName('Kititemflag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->kititemflag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : SalesOrderDetailTableMap::translateFieldName('Promocode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->promocode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : SalesOrderDetailTableMap::translateFieldName('Taxcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : SalesOrderDetailTableMap::translateFieldName('Taxcodeperc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcodeperc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : SalesOrderDetailTableMap::translateFieldName('Discpct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discpct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : SalesOrderDetailTableMap::translateFieldName('Listprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->listprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : SalesOrderDetailTableMap::translateFieldName('Uomconv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uomconv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : SalesOrderDetailTableMap::translateFieldName('Vendorid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendorid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : SalesOrderDetailTableMap::translateFieldName('Vendoritemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendoritemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : SalesOrderDetailTableMap::translateFieldName('Mfgid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mfgid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : SalesOrderDetailTableMap::translateFieldName('Mfgitemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->mfgitemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : SalesOrderDetailTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : SalesOrderDetailTableMap::translateFieldName('Lostreason', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lostreason = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : SalesOrderDetailTableMap::translateFieldName('Lostdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lostdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : SalesOrderDetailTableMap::translateFieldName('Notes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : SalesOrderDetailTableMap::translateFieldName('Leaddays', TableMap::TYPE_PHPNAME, $indexType)];
            $this->leaddays = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : SalesOrderDetailTableMap::translateFieldName('Ordrtotalcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordrtotalcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : SalesOrderDetailTableMap::translateFieldName('Costuom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->costuom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : SalesOrderDetailTableMap::translateFieldName('Stancost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->stancost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : SalesOrderDetailTableMap::translateFieldName('Quotind', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotind = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : SalesOrderDetailTableMap::translateFieldName('Quotqty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotqty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : SalesOrderDetailTableMap::translateFieldName('Quotprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : SalesOrderDetailTableMap::translateFieldName('Quotcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : SalesOrderDetailTableMap::translateFieldName('Quotmkupmarg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotmkupmarg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : SalesOrderDetailTableMap::translateFieldName('Quotdiscpct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotdiscpct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : SalesOrderDetailTableMap::translateFieldName('Errormsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->errormsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : SalesOrderDetailTableMap::translateFieldName('Minprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->minprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : SalesOrderDetailTableMap::translateFieldName('Ponbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ponbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : SalesOrderDetailTableMap::translateFieldName('Poref', TableMap::TYPE_PHPNAME, $indexType)];
            $this->poref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : SalesOrderDetailTableMap::translateFieldName('Nsitemgroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nsitemgroup = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : SalesOrderDetailTableMap::translateFieldName('Shipfromid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipfromid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : SalesOrderDetailTableMap::translateFieldName('Itemtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : SalesOrderDetailTableMap::translateFieldName('Canbackorder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->canbackorder = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : SalesOrderDetailTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 60; // 60 = SalesOrderDetailTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_RECNO)) {
            $modifiedColumns[':p' . $index++]  = 'recno';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ORDERNO)) {
            $modifiedColumns[':p' . $index++]  = 'orderno';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LINENBR)) {
            $modifiedColumns[':p' . $index++]  = 'linenbr';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SUBLINENBR)) {
            $modifiedColumns[':p' . $index++]  = 'sublinenbr';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'itemid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_CUSTITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'custitemid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DESC1)) {
            $modifiedColumns[':p' . $index++]  = 'desc1';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DESC2)) {
            $modifiedColumns[':p' . $index++]  = 'desc2';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TOTALPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'totalprice';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'qty';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTYSHIPPED)) {
            $modifiedColumns[':p' . $index++]  = 'qtyshipped';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTYBACKORD)) {
            $modifiedColumns[':p' . $index++]  = 'qtybackord';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_RSHIPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rshipdate';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_HASDOCUMENTS)) {
            $modifiedColumns[':p' . $index++]  = 'hasdocuments';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTYAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'qtyavail';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_HASNOTES)) {
            $modifiedColumns[':p' . $index++]  = 'hasnotes';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_COST)) {
            $modifiedColumns[':p' . $index++]  = 'cost';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'whse';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_UOM)) {
            $modifiedColumns[':p' . $index++]  = 'uom';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SPCORD)) {
            $modifiedColumns[':p' . $index++]  = 'spcord';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_KITITEMFLAG)) {
            $modifiedColumns[':p' . $index++]  = 'kititemflag';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_PROMOCODE)) {
            $modifiedColumns[':p' . $index++]  = 'promocode';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TAXCODE)) {
            $modifiedColumns[':p' . $index++]  = 'taxcode';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TAXCODEPERC)) {
            $modifiedColumns[':p' . $index++]  = 'taxcodeperc';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DISCPCT)) {
            $modifiedColumns[':p' . $index++]  = 'discpct';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LISTPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'listprice';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_UOMCONV)) {
            $modifiedColumns[':p' . $index++]  = 'uomconv';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_VENDORID)) {
            $modifiedColumns[':p' . $index++]  = 'vendorid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_VENDORITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'vendoritemid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_MFGID)) {
            $modifiedColumns[':p' . $index++]  = 'mfgid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_MFGITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'mfgitemid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LOSTREASON)) {
            $modifiedColumns[':p' . $index++]  = 'lostreason';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LOSTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'lostdate';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_NOTES)) {
            $modifiedColumns[':p' . $index++]  = 'notes';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LEADDAYS)) {
            $modifiedColumns[':p' . $index++]  = 'leaddays';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ORDRTOTALCOST)) {
            $modifiedColumns[':p' . $index++]  = 'ordrtotalcost';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_COSTUOM)) {
            $modifiedColumns[':p' . $index++]  = 'costuom';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_STANCOST)) {
            $modifiedColumns[':p' . $index++]  = 'stancost';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTIND)) {
            $modifiedColumns[':p' . $index++]  = 'quotind';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTQTY)) {
            $modifiedColumns[':p' . $index++]  = 'quotqty';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'quotprice';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTCOST)) {
            $modifiedColumns[':p' . $index++]  = 'quotcost';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTMKUPMARG)) {
            $modifiedColumns[':p' . $index++]  = 'quotmkupmarg';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTDISCPCT)) {
            $modifiedColumns[':p' . $index++]  = 'quotdiscpct';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ERRORMSG)) {
            $modifiedColumns[':p' . $index++]  = 'errormsg';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_MINPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'minprice';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_PONBR)) {
            $modifiedColumns[':p' . $index++]  = 'ponbr';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_POREF)) {
            $modifiedColumns[':p' . $index++]  = 'poref';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_NSITEMGROUP)) {
            $modifiedColumns[':p' . $index++]  = 'nsitemgroup';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SHIPFROMID)) {
            $modifiedColumns[':p' . $index++]  = 'shipfromid';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ITEMTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'itemtype';
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_CANBACKORDER)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SESSIONID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_RECNO)) {
            $criteria->add(SalesOrderDetailTableMap::COL_RECNO, $this->recno);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DATE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TIME)) {
            $criteria->add(SalesOrderDetailTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TYPE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ORDERNO)) {
            $criteria->add(SalesOrderDetailTableMap::COL_ORDERNO, $this->orderno);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LINENBR)) {
            $criteria->add(SalesOrderDetailTableMap::COL_LINENBR, $this->linenbr);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SUBLINENBR)) {
            $criteria->add(SalesOrderDetailTableMap::COL_SUBLINENBR, $this->sublinenbr);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ITEMID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_ITEMID, $this->itemid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_CUSTID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_CUSTITEMID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_CUSTITEMID, $this->custitemid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DESC1)) {
            $criteria->add(SalesOrderDetailTableMap::COL_DESC1, $this->desc1);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DESC2)) {
            $criteria->add(SalesOrderDetailTableMap::COL_DESC2, $this->desc2);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_PRICE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TOTALPRICE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_TOTALPRICE, $this->totalprice);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTY)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QTY, $this->qty);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTYSHIPPED)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QTYSHIPPED, $this->qtyshipped);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTYBACKORD)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QTYBACKORD, $this->qtybackord);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_RSHIPDATE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_RSHIPDATE, $this->rshipdate);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_HASDOCUMENTS)) {
            $criteria->add(SalesOrderDetailTableMap::COL_HASDOCUMENTS, $this->hasdocuments);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QTYAVAIL)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QTYAVAIL, $this->qtyavail);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_HASNOTES)) {
            $criteria->add(SalesOrderDetailTableMap::COL_HASNOTES, $this->hasnotes);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_COST)) {
            $criteria->add(SalesOrderDetailTableMap::COL_COST, $this->cost);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_WHSE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_WHSE, $this->whse);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_UOM)) {
            $criteria->add(SalesOrderDetailTableMap::COL_UOM, $this->uom);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SPCORD)) {
            $criteria->add(SalesOrderDetailTableMap::COL_SPCORD, $this->spcord);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_KITITEMFLAG)) {
            $criteria->add(SalesOrderDetailTableMap::COL_KITITEMFLAG, $this->kititemflag);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_PROMOCODE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_PROMOCODE, $this->promocode);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TAXCODE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_TAXCODE, $this->taxcode);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_TAXCODEPERC)) {
            $criteria->add(SalesOrderDetailTableMap::COL_TAXCODEPERC, $this->taxcodeperc);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DISCPCT)) {
            $criteria->add(SalesOrderDetailTableMap::COL_DISCPCT, $this->discpct);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LISTPRICE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_LISTPRICE, $this->listprice);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_UOMCONV)) {
            $criteria->add(SalesOrderDetailTableMap::COL_UOMCONV, $this->uomconv);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_VENDORID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_VENDORID, $this->vendorid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_VENDORITEMID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_VENDORITEMID, $this->vendoritemid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_MFGID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_MFGID, $this->mfgid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_MFGITEMID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_MFGITEMID, $this->mfgitemid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_STATUS)) {
            $criteria->add(SalesOrderDetailTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LOSTREASON)) {
            $criteria->add(SalesOrderDetailTableMap::COL_LOSTREASON, $this->lostreason);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LOSTDATE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_LOSTDATE, $this->lostdate);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_NOTES)) {
            $criteria->add(SalesOrderDetailTableMap::COL_NOTES, $this->notes);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_LEADDAYS)) {
            $criteria->add(SalesOrderDetailTableMap::COL_LEADDAYS, $this->leaddays);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ORDRTOTALCOST)) {
            $criteria->add(SalesOrderDetailTableMap::COL_ORDRTOTALCOST, $this->ordrtotalcost);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_COSTUOM)) {
            $criteria->add(SalesOrderDetailTableMap::COL_COSTUOM, $this->costuom);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_STANCOST)) {
            $criteria->add(SalesOrderDetailTableMap::COL_STANCOST, $this->stancost);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTIND)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QUOTIND, $this->quotind);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTQTY)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QUOTQTY, $this->quotqty);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTPRICE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QUOTPRICE, $this->quotprice);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTCOST)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QUOTCOST, $this->quotcost);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTMKUPMARG)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QUOTMKUPMARG, $this->quotmkupmarg);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_QUOTDISCPCT)) {
            $criteria->add(SalesOrderDetailTableMap::COL_QUOTDISCPCT, $this->quotdiscpct);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ERRORMSG)) {
            $criteria->add(SalesOrderDetailTableMap::COL_ERRORMSG, $this->errormsg);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_MINPRICE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_MINPRICE, $this->minprice);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_PONBR)) {
            $criteria->add(SalesOrderDetailTableMap::COL_PONBR, $this->ponbr);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_POREF)) {
            $criteria->add(SalesOrderDetailTableMap::COL_POREF, $this->poref);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_NSITEMGROUP)) {
            $criteria->add(SalesOrderDetailTableMap::COL_NSITEMGROUP, $this->nsitemgroup);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_SHIPFROMID)) {
            $criteria->add(SalesOrderDetailTableMap::COL_SHIPFROMID, $this->shipfromid);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_ITEMTYPE)) {
            $criteria->add(SalesOrderDetailTableMap::COL_ITEMTYPE, $this->itemtype);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_CANBACKORDER)) {
            $criteria->add(SalesOrderDetailTableMap::COL_CANBACKORDER, $this->canbackorder);
        }
        if ($this->isColumnModified(SalesOrderDetailTableMap::COL_DUMMY)) {
