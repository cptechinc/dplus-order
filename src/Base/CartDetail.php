 ...
 */
abstract class CartDetail implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CartDetailTableMap';
    ...
    /**
     * Initializes internal state of Base\CartDetail object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CartDetail</code> instance.  If
     * <code>obj</code> is an instance of <code>CartDetail</code>, delegates to
     * <code>equals(CartDetail)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CartDetail The current object, for fluid interface
     */
     ...
     * @return $this|\CartDetail The current object (for fluent API support)
     */
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecno($v)
    {
        ...
        if ($this->recno !== $v) {
            $this->recno = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_RECNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_TIME] = true;
        }
    ...
    public function setOrderno($v)
    {
        ...
        if ($this->orderno !== $v) {
            $this->orderno = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_ORDERNO] = true;
        }
    ...
    public function setLinenbr($v)
    {
        ...
        if ($this->linenbr !== $v) {
            $this->linenbr = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_LINENBR] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_ITEMID] = true;
        }
    ...
    public function setCustitemid($v)
    {
        ...
        if ($this->custitemid !== $v) {
            $this->custitemid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_CUSTITEMID] = true;
        }
    ...
    public function setDesc1($v)
    {
        ...
        if ($this->desc1 !== $v) {
            $this->desc1 = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_DESC1] = true;
        }
    ...
    public function setDesc2($v)
    {
        ...
        if ($this->desc2 !== $v) {
            $this->desc2 = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_DESC2] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_PRICE] = true;
        }
    ...
    public function setTotalprice($v)
    {
        ...
        if ($this->totalprice !== $v) {
            $this->totalprice = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_TOTALPRICE] = true;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_QTY] = true;
        }
    ...
    public function setQtyshipped($v)
    {
        ...
        if ($this->qtyshipped !== $v) {
            $this->qtyshipped = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_QTYSHIPPED] = true;
        }
    ...
    public function setQtybackord($v)
    {
        ...
        if ($this->qtybackord !== $v) {
            $this->qtybackord = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_QTYBACKORD] = true;
        }
    ...
    public function setRshipdate($v)
    {
        ...
        if ($this->rshipdate !== $v) {
            $this->rshipdate = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_RSHIPDATE] = true;
        }
    ...
    public function setHasdocuments($v)
    {
        ...
        if ($this->hasdocuments !== $v) {
            $this->hasdocuments = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_HASDOCUMENTS] = true;
        }
    ...
    public function setQtyavail($v)
    {
        ...
        if ($this->qtyavail !== $v) {
            $this->qtyavail = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_QTYAVAIL] = true;
        }
    ...
    public function setHasnotes($v)
    {
        ...
        if ($this->hasnotes !== $v) {
            $this->hasnotes = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_HASNOTES] = true;
        }
    ...
    public function setCost($v)
    {
        ...
        if ($this->cost !== $v) {
            $this->cost = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_COST] = true;
        }
    ...
    public function setWhse($v)
    {
        ...
        if ($this->whse !== $v) {
            $this->whse = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_WHSE] = true;
        }
    ...
    public function setUom($v)
    {
        ...
        if ($this->uom !== $v) {
            $this->uom = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_UOM] = true;
        }
    ...
    public function setSpcord($v)
    {
        ...
        if ($this->spcord !== $v) {
            $this->spcord = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_SPCORD] = true;
        }
    ...
    public function setKititemflag($v)
    {
        ...
        if ($this->kititemflag !== $v) {
            $this->kititemflag = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_KITITEMFLAG] = true;
        }
    ...
    public function setPromocode($v)
    {
        ...
        if ($this->promocode !== $v) {
            $this->promocode = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_PROMOCODE] = true;
        }
    ...
    public function setTaxcode($v)
    {
        ...
        if ($this->taxcode !== $v) {
            $this->taxcode = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_TAXCODE] = true;
        }
    ...
    public function setTaxcodeperc($v)
    {
        ...
        if ($this->taxcodeperc !== $v) {
            $this->taxcodeperc = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_TAXCODEPERC] = true;
        }
    ...
    public function setDiscpct($v)
    {
        ...
        if ($this->discpct !== $v) {
            $this->discpct = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_DISCPCT] = true;
        }
    ...
    public function setListprice($v)
    {
        ...
        if ($this->listprice !== $v) {
            $this->listprice = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_LISTPRICE] = true;
        }
    ...
    public function setUomconv($v)
    {
        ...
        if ($this->uomconv !== $v) {
            $this->uomconv = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_UOMCONV] = true;
        }
    ...
    public function setCatlgid($v)
    {
        ...
        if ($this->catlgid !== $v) {
            $this->catlgid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_CATLGID] = true;
        }
    ...
    public function setErrormsg($v)
    {
        ...
        if ($this->errormsg !== $v) {
            $this->errormsg = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_ERRORMSG] = true;
        }
    ...
    public function setMinprice($v)
    {
        ...
        if ($this->minprice !== $v) {
            $this->minprice = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_MINPRICE] = true;
        }
    ...
    public function setVendorid($v)
    {
        ...
        if ($this->vendorid !== $v) {
            $this->vendorid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_VENDORID] = true;
        }
    ...
    public function setVendoritemid($v)
    {
        ...
        if ($this->vendoritemid !== $v) {
            $this->vendoritemid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_VENDORITEMID] = true;
        }
    ...
    public function setPonbr($v)
    {
        ...
        if ($this->ponbr !== $v) {
            $this->ponbr = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_PONBR] = true;
        }
    ...
    public function setPoref($v)
    {
        ...
        if ($this->poref !== $v) {
            $this->poref = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_POREF] = true;
        }
    ...
    public function setNsitemgroup($v)
    {
        ...
        if ($this->nsitemgroup !== $v) {
            $this->nsitemgroup = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_NSITEMGROUP] = true;
        }
    ...
    public function setShipfromid($v)
    {
        ...
        if ($this->shipfromid !== $v) {
            $this->shipfromid = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_SHIPFROMID] = true;
        }
    ...
    public function setItemtype($v)
    {
        ...
        if ($this->itemtype !== $v) {
            $this->itemtype = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_ITEMTYPE] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[CartDetailTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CartDetailTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartDetailTableMap::translateFieldName('Recno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CartDetailTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CartDetailTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CartDetailTableMap::translateFieldName('Orderno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CartDetailTableMap::translateFieldName('Linenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->linenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CartDetailTableMap::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CartDetailTableMap::translateFieldName('Custitemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custitemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CartDetailTableMap::translateFieldName('Desc1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CartDetailTableMap::translateFieldName('Desc2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CartDetailTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CartDetailTableMap::translateFieldName('Totalprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CartDetailTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qty = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CartDetailTableMap::translateFieldName('Qtyshipped', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtyshipped = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CartDetailTableMap::translateFieldName('Qtybackord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtybackord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CartDetailTableMap::translateFieldName('Rshipdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rshipdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CartDetailTableMap::translateFieldName('Hasdocuments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasdocuments = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : CartDetailTableMap::translateFieldName('Qtyavail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtyavail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : CartDetailTableMap::translateFieldName('Hasnotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasnotes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : CartDetailTableMap::translateFieldName('Cost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : CartDetailTableMap::translateFieldName('Whse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : CartDetailTableMap::translateFieldName('Uom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : CartDetailTableMap::translateFieldName('Spcord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->spcord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : CartDetailTableMap::translateFieldName('Kititemflag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->kititemflag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : CartDetailTableMap::translateFieldName('Promocode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->promocode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : CartDetailTableMap::translateFieldName('Taxcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : CartDetailTableMap::translateFieldName('Taxcodeperc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcodeperc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : CartDetailTableMap::translateFieldName('Discpct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discpct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : CartDetailTableMap::translateFieldName('Listprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->listprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : CartDetailTableMap::translateFieldName('Uomconv', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uomconv = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : CartDetailTableMap::translateFieldName('Catlgid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->catlgid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : CartDetailTableMap::translateFieldName('Errormsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->errormsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : CartDetailTableMap::translateFieldName('Minprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->minprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : CartDetailTableMap::translateFieldName('Vendorid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendorid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : CartDetailTableMap::translateFieldName('Vendoritemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendoritemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : CartDetailTableMap::translateFieldName('Ponbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ponbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : CartDetailTableMap::translateFieldName('Poref', TableMap::TYPE_PHPNAME, $indexType)];
            $this->poref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : CartDetailTableMap::translateFieldName('Nsitemgroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nsitemgroup = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : CartDetailTableMap::translateFieldName('Shipfromid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipfromid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : CartDetailTableMap::translateFieldName('Itemtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : CartDetailTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 41; // 41 = CartDetailTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CartDetail'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCartDetailQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CartDetail::setDeleted()
     * @see CartDetail::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCartDetailQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CartDetailTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CartDetailTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_RECNO)) {
            $modifiedColumns[':p' . $index++]  = 'recno';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ORDERNO)) {
            $modifiedColumns[':p' . $index++]  = 'orderno';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_LINENBR)) {
            $modifiedColumns[':p' . $index++]  = 'linenbr';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'itemid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_CUSTITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'custitemid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DESC1)) {
            $modifiedColumns[':p' . $index++]  = 'desc1';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DESC2)) {
            $modifiedColumns[':p' . $index++]  = 'desc2';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TOTALPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'totalprice';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'qty';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTYSHIPPED)) {
            $modifiedColumns[':p' . $index++]  = 'qtyshipped';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTYBACKORD)) {
            $modifiedColumns[':p' . $index++]  = 'qtybackord';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_RSHIPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rshipdate';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_HASDOCUMENTS)) {
            $modifiedColumns[':p' . $index++]  = 'hasdocuments';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTYAVAIL)) {
            $modifiedColumns[':p' . $index++]  = 'qtyavail';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_HASNOTES)) {
            $modifiedColumns[':p' . $index++]  = 'hasnotes';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_COST)) {
            $modifiedColumns[':p' . $index++]  = 'cost';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'whse';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_UOM)) {
            $modifiedColumns[':p' . $index++]  = 'uom';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_SPCORD)) {
            $modifiedColumns[':p' . $index++]  = 'spcord';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_KITITEMFLAG)) {
            $modifiedColumns[':p' . $index++]  = 'kititemflag';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_PROMOCODE)) {
            $modifiedColumns[':p' . $index++]  = 'promocode';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TAXCODE)) {
            $modifiedColumns[':p' . $index++]  = 'taxcode';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TAXCODEPERC)) {
            $modifiedColumns[':p' . $index++]  = 'taxcodeperc';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DISCPCT)) {
            $modifiedColumns[':p' . $index++]  = 'discpct';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_LISTPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'listprice';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_UOMCONV)) {
            $modifiedColumns[':p' . $index++]  = 'uomconv';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_CATLGID)) {
            $modifiedColumns[':p' . $index++]  = 'catlgid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ERRORMSG)) {
            $modifiedColumns[':p' . $index++]  = 'errormsg';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_MINPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'minprice';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_VENDORID)) {
            $modifiedColumns[':p' . $index++]  = 'vendorid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_VENDORITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'vendoritemid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_PONBR)) {
            $modifiedColumns[':p' . $index++]  = 'ponbr';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_POREF)) {
            $modifiedColumns[':p' . $index++]  = 'poref';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_NSITEMGROUP)) {
            $modifiedColumns[':p' . $index++]  = 'nsitemgroup';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_SHIPFROMID)) {
            $modifiedColumns[':p' . $index++]  = 'shipfromid';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ITEMTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'itemtype';
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DUMMY)) {
    ...
    {
        $pos = CartDetailTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CartDetail'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CartDetail'][$this->hashCode()] = true;
        $keys = CartDetailTableMap::getFieldNames($keyType);
        $result = array(
    ...
    {
        $criteria = new Criteria(CartDetailTableMap::DATABASE_NAME);

        if ($this->isColumnModified(CartDetailTableMap::COL_SESSIONID)) {
            $criteria->add(CartDetailTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_RECNO)) {
            $criteria->add(CartDetailTableMap::COL_RECNO, $this->recno);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DATE)) {
            $criteria->add(CartDetailTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TIME)) {
            $criteria->add(CartDetailTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ORDERNO)) {
            $criteria->add(CartDetailTableMap::COL_ORDERNO, $this->orderno);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_LINENBR)) {
            $criteria->add(CartDetailTableMap::COL_LINENBR, $this->linenbr);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ITEMID)) {
            $criteria->add(CartDetailTableMap::COL_ITEMID, $this->itemid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_CUSTITEMID)) {
            $criteria->add(CartDetailTableMap::COL_CUSTITEMID, $this->custitemid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DESC1)) {
            $criteria->add(CartDetailTableMap::COL_DESC1, $this->desc1);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DESC2)) {
            $criteria->add(CartDetailTableMap::COL_DESC2, $this->desc2);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_PRICE)) {
            $criteria->add(CartDetailTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TOTALPRICE)) {
            $criteria->add(CartDetailTableMap::COL_TOTALPRICE, $this->totalprice);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTY)) {
            $criteria->add(CartDetailTableMap::COL_QTY, $this->qty);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTYSHIPPED)) {
            $criteria->add(CartDetailTableMap::COL_QTYSHIPPED, $this->qtyshipped);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTYBACKORD)) {
            $criteria->add(CartDetailTableMap::COL_QTYBACKORD, $this->qtybackord);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_RSHIPDATE)) {
            $criteria->add(CartDetailTableMap::COL_RSHIPDATE, $this->rshipdate);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_HASDOCUMENTS)) {
            $criteria->add(CartDetailTableMap::COL_HASDOCUMENTS, $this->hasdocuments);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_QTYAVAIL)) {
            $criteria->add(CartDetailTableMap::COL_QTYAVAIL, $this->qtyavail);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_HASNOTES)) {
            $criteria->add(CartDetailTableMap::COL_HASNOTES, $this->hasnotes);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_COST)) {
            $criteria->add(CartDetailTableMap::COL_COST, $this->cost);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_WHSE)) {
            $criteria->add(CartDetailTableMap::COL_WHSE, $this->whse);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_UOM)) {
            $criteria->add(CartDetailTableMap::COL_UOM, $this->uom);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_SPCORD)) {
            $criteria->add(CartDetailTableMap::COL_SPCORD, $this->spcord);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_KITITEMFLAG)) {
            $criteria->add(CartDetailTableMap::COL_KITITEMFLAG, $this->kititemflag);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_PROMOCODE)) {
            $criteria->add(CartDetailTableMap::COL_PROMOCODE, $this->promocode);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TAXCODE)) {
            $criteria->add(CartDetailTableMap::COL_TAXCODE, $this->taxcode);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_TAXCODEPERC)) {
            $criteria->add(CartDetailTableMap::COL_TAXCODEPERC, $this->taxcodeperc);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DISCPCT)) {
            $criteria->add(CartDetailTableMap::COL_DISCPCT, $this->discpct);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_LISTPRICE)) {
            $criteria->add(CartDetailTableMap::COL_LISTPRICE, $this->listprice);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_UOMCONV)) {
            $criteria->add(CartDetailTableMap::COL_UOMCONV, $this->uomconv);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_CATLGID)) {
            $criteria->add(CartDetailTableMap::COL_CATLGID, $this->catlgid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ERRORMSG)) {
            $criteria->add(CartDetailTableMap::COL_ERRORMSG, $this->errormsg);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_MINPRICE)) {
            $criteria->add(CartDetailTableMap::COL_MINPRICE, $this->minprice);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_VENDORID)) {
            $criteria->add(CartDetailTableMap::COL_VENDORID, $this->vendorid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_VENDORITEMID)) {
            $criteria->add(CartDetailTableMap::COL_VENDORITEMID, $this->vendoritemid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_PONBR)) {
            $criteria->add(CartDetailTableMap::COL_PONBR, $this->ponbr);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_POREF)) {
            $criteria->add(CartDetailTableMap::COL_POREF, $this->poref);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_NSITEMGROUP)) {
            $criteria->add(CartDetailTableMap::COL_NSITEMGROUP, $this->nsitemgroup);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_SHIPFROMID)) {
            $criteria->add(CartDetailTableMap::COL_SHIPFROMID, $this->shipfromid);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_ITEMTYPE)) {
            $criteria->add(CartDetailTableMap::COL_ITEMTYPE, $this->itemtype);
        }
        if ($this->isColumnModified(CartDetailTableMap::COL_DUMMY)) {
            $criteria->add(CartDetailTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildCartDetailQuery::create();
        $criteria->add(CartDetailTableMap::COL_SESSIONID, $this->sessionid);
        $criteria->add(CartDetailTableMap::COL_RECNO, $this->recno);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CartDetail (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CartDetail Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CartDetailTableMap::DEFAULT_STRING_FORMAT);
    }
