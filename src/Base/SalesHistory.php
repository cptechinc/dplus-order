...
abstract class SalesHistory implements ActiveRecordInterface
{
    ...
    public function setOrdernumber($v)
    {
        ...
        if ($this->ordernumber !== $v) {
            $this->ordernumber = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_ORDERNUMBER] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_CUSTID] = true;
        }
    ...
    public function setShiptoid($v)
    {
        ...
        if ($this->shiptoid !== $v) {
            $this->shiptoid = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_SHIPTOID] = true;
        }
    ...
    public function setCustname($v)
    {
        ...
        if ($this->custname !== $v) {
            $this->custname = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_CUSTNAME] = true;
        }
    ...
    public function setCustpo($v)
    {
        ...
        if ($this->custpo !== $v) {
            $this->custpo = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_CUSTPO] = true;
        }
    ...
    public function setOrderDate($v)
    {
        ...
        if ($this->order_date !== $v) {
            $this->order_date = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_ORDER_DATE] = true;
        }
    ...
    public function setInvoiceDate($v)
    {
        ...
        if ($this->invoice_date !== $v) {
            $this->invoice_date = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_INVOICE_DATE] = true;
        }
    ...
    public function setSalesperson1($v)
    {
        ...
        if ($this->salesperson_1 !== $v) {
            ...
            $this->modifiedColumns[SalesHistoryTableMap::COL_SALESPERSON_1] = true;
        }
    ...
    public function setSp1login($v)
    {
        ...
        if ($this->sp1login !== $v) {
            $this->sp1login = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_SP1LOGIN] = true;
        }
    ...
    public function setHasTracking($v)
    {
        ...
        if ($this->has_tracking !== $v) {
            $this->has_tracking = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_HAS_TRACKING] = true;
        }
    ...
    public function setSubtotalNontax($v)
    {
        ...
        if ($this->subtotal_nontax !== $v) {
            ...
            $this->modifiedColumns[SalesHistoryTableMap::COL_SUBTOTAL_NONTAX] = true;
        }
    ...
    public function setTotalTax($v)
    {
        ...
        if ($this->total_tax !== $v) {
            $this->total_tax = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_TOTAL_TAX] = true;
        }
    ...
    public function setTotalFreight($v)
    {
        ...
        if ($this->total_freight !== $v) {
            ...
            $this->modifiedColumns[SalesHistoryTableMap::COL_TOTAL_FREIGHT] = true;
        }
    ...
    public function setTotalMisc($v)
    {
        ...
        if ($this->total_misc !== $v) {
            $this->total_misc = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_TOTAL_MISC] = true;
        }
    ...
    public function setTotalOrder($v)
    {
        ...
        if ($this->total_order !== $v) {
            $this->total_order = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_TOTAL_ORDER] = true;
        }
    ...
    public function setHasDocuments($v)
    {
        ...
        if ($this->has_documents !== $v) {
            ...
            $this->modifiedColumns[SalesHistoryTableMap::COL_HAS_DOCUMENTS] = true;
        }
    ...
    public function setHasNotes($v)
    {
        ...
        if ($this->has_notes !== $v) {
            $this->has_notes = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_HAS_NOTES] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[SalesHistoryTableMap::COL_DATE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SalesHistoryTableMap::translateFieldName('Ordernumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordernumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SalesHistoryTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SalesHistoryTableMap::translateFieldName('Shiptoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shiptoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SalesHistoryTableMap::translateFieldName('Custname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SalesHistoryTableMap::translateFieldName('Custpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custpo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SalesHistoryTableMap::translateFieldName('OrderDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SalesHistoryTableMap::translateFieldName('InvoiceDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SalesHistoryTableMap::translateFieldName('Salesperson1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SalesHistoryTableMap::translateFieldName('Sp1login', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1login = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SalesHistoryTableMap::translateFieldName('HasTracking', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_tracking = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SalesHistoryTableMap::translateFieldName('SubtotalNontax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal_nontax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SalesHistoryTableMap::translateFieldName('TotalTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SalesHistoryTableMap::translateFieldName('TotalFreight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SalesHistoryTableMap::translateFieldName('TotalMisc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_misc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : SalesHistoryTableMap::translateFieldName('TotalOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_order = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : SalesHistoryTableMap::translateFieldName('HasDocuments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_documents = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SalesHistoryTableMap::translateFieldName('HasNotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SalesHistoryTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : SalesHistoryTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : SalesHistoryTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 20; // 20 = SalesHistoryTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SalesHistoryTableMap::COL_ORDERNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'ordernumber';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SHIPTOID)) {
            $modifiedColumns[':p' . $index++]  = 'shiptoid';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_CUSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'custname';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_CUSTPO)) {
            $modifiedColumns[':p' . $index++]  = 'custpo';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_ORDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'order_date';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_INVOICE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_date';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SALESPERSON_1)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_1';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SP1LOGIN)) {
            $modifiedColumns[':p' . $index++]  = 'sp1login';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_HAS_TRACKING)) {
            $modifiedColumns[':p' . $index++]  = 'has_tracking';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SUBTOTAL_NONTAX)) {
            $modifiedColumns[':p' . $index++]  = 'subtotal_nontax';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'total_tax';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'total_freight';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_MISC)) {
            $modifiedColumns[':p' . $index++]  = 'total_misc';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'total_order';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_HAS_DOCUMENTS)) {
            $modifiedColumns[':p' . $index++]  = 'has_documents';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_HAS_NOTES)) {
            $modifiedColumns[':p' . $index++]  = 'has_notes';
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_DATE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SalesHistoryTableMap::COL_ORDERNUMBER)) {
            $criteria->add(SalesHistoryTableMap::COL_ORDERNUMBER, $this->ordernumber);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_CUSTID)) {
            $criteria->add(SalesHistoryTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SHIPTOID)) {
            $criteria->add(SalesHistoryTableMap::COL_SHIPTOID, $this->shiptoid);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_CUSTNAME)) {
            $criteria->add(SalesHistoryTableMap::COL_CUSTNAME, $this->custname);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_CUSTPO)) {
            $criteria->add(SalesHistoryTableMap::COL_CUSTPO, $this->custpo);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_ORDER_DATE)) {
            $criteria->add(SalesHistoryTableMap::COL_ORDER_DATE, $this->order_date);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_INVOICE_DATE)) {
            $criteria->add(SalesHistoryTableMap::COL_INVOICE_DATE, $this->invoice_date);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SALESPERSON_1)) {
            $criteria->add(SalesHistoryTableMap::COL_SALESPERSON_1, $this->salesperson_1);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SP1LOGIN)) {
            $criteria->add(SalesHistoryTableMap::COL_SP1LOGIN, $this->sp1login);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_HAS_TRACKING)) {
            $criteria->add(SalesHistoryTableMap::COL_HAS_TRACKING, $this->has_tracking);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_SUBTOTAL_NONTAX)) {
            $criteria->add(SalesHistoryTableMap::COL_SUBTOTAL_NONTAX, $this->subtotal_nontax);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_TAX)) {
            $criteria->add(SalesHistoryTableMap::COL_TOTAL_TAX, $this->total_tax);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_FREIGHT)) {
            $criteria->add(SalesHistoryTableMap::COL_TOTAL_FREIGHT, $this->total_freight);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_MISC)) {
            $criteria->add(SalesHistoryTableMap::COL_TOTAL_MISC, $this->total_misc);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TOTAL_ORDER)) {
            $criteria->add(SalesHistoryTableMap::COL_TOTAL_ORDER, $this->total_order);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_HAS_DOCUMENTS)) {
            $criteria->add(SalesHistoryTableMap::COL_HAS_DOCUMENTS, $this->has_documents);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_HAS_NOTES)) {
            $criteria->add(SalesHistoryTableMap::COL_HAS_NOTES, $this->has_notes);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_DATE)) {
            $criteria->add(SalesHistoryTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(SalesHistoryTableMap::COL_TIME)) {
