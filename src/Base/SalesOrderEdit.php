 ...
 */
abstract class SalesOrderEdit implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\SalesOrderEditTableMap';
    ...
    /**
     * Initializes internal state of Base\SalesOrderEdit object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>SalesOrderEdit</code> instance.  If
     * <code>obj</code> is an instance of <code>SalesOrderEdit</code>, delegates to
     * <code>equals(SalesOrderEdit)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|SalesOrderEdit The current object, for fluid interface
     */
     ...
     * @return $this|\SalesOrderEdit The current object (for fluent API support)
     */
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecno($v)
    {
        ...
        if ($this->recno !== $v) {
            $this->recno = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_RECNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TIME] = true;
        }
    ...
    public function setType($v)
    {
        ...
        if ($this->type !== $v) {
            $this->type = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TYPE] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CUSTID] = true;
        }
    ...
    public function setShiptoid($v)
    {
        ...
        if ($this->shiptoid !== $v) {
            $this->shiptoid = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPTOID] = true;
        }
    ...
    public function setCustname($v)
    {
        ...
        if ($this->custname !== $v) {
            $this->custname = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CUSTNAME] = true;
        }
    ...
    public function setOrderno($v)
    {
        ...
        if ($this->orderno !== $v) {
            $this->orderno = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_ORDERNO] = true;
        }
    ...
    public function setCustpo($v)
    {
        ...
        if ($this->custpo !== $v) {
            $this->custpo = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CUSTPO] = true;
        }
    ...
    public function setCustref($v)
    {
        ...
        if ($this->custref !== $v) {
            $this->custref = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CUSTREF] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_STATUS] = true;
        }
    ...
    public function setOrderdate($v)
    {
        ...
        if ($this->orderdate !== $v) {
            $this->orderdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_ORDERDATE] = true;
        }
    ...
    public function setCareof($v)
    {
        ...
        if ($this->careof !== $v) {
            $this->careof = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CAREOF] = true;
        }
    ...
    public function setQuotdate($v)
    {
        ...
        if ($this->quotdate !== $v) {
            $this->quotdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_QUOTDATE] = true;
        }
    ...
    public function setInvdate($v)
    {
        ...
        if ($this->invdate !== $v) {
            $this->invdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_INVDATE] = true;
        }
    ...
    public function setShipdate($v)
    {
        ...
        if ($this->shipdate !== $v) {
            $this->shipdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPDATE] = true;
        }
    ...
    public function setRevdate($v)
    {
        ...
        if ($this->revdate !== $v) {
            $this->revdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_REVDATE] = true;
        }
    ...
    public function setExpdate($v)
    {
        ...
        if ($this->expdate !== $v) {
            $this->expdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_EXPDATE] = true;
        }
    ...
    public function setHasdocuments($v)
    {
        ...
        if ($this->hasdocuments !== $v) {
            $this->hasdocuments = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_HASDOCUMENTS] = true;
        }
    ...
    public function setHastracking($v)
    {
        ...
        if ($this->hastracking !== $v) {
            $this->hastracking = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_HASTRACKING] = true;
        }
    ...
    public function setSubtotal($v)
    {
        ...
        if ($this->subtotal !== $v) {
            $this->subtotal = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SUBTOTAL] = true;
        }
    ...
    public function setSalestax($v)
    {
        ...
        if ($this->salestax !== $v) {
            $this->salestax = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SALESTAX] = true;
        }
    ...
    public function setFreight($v)
    {
        ...
        if ($this->freight !== $v) {
            $this->freight = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_FREIGHT] = true;
        }
    ...
    public function setMisccost($v)
    {
        ...
        if ($this->misccost !== $v) {
            $this->misccost = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_MISCCOST] = true;
        }
    ...
    public function setOrdertotal($v)
    {
        ...
        if ($this->ordertotal !== $v) {
            $this->ordertotal = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_ORDERTOTAL] = true;
        }
    ...
    public function setHasnotes($v)
    {
        ...
        if ($this->hasnotes !== $v) {
            $this->hasnotes = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_HASNOTES] = true;
        }
    ...
    public function setEditord($v)
    {
        ...
        if ($this->editord !== $v) {
            $this->editord = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_EDITORD] = true;
        }
    ...
    public function setError($v)
    {
        ...
        if ($this->error !== $v) {
            $this->error = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_ERROR] = true;
        }
    ...
    public function setErrormsg($v)
    {
        ...
        if ($this->errormsg !== $v) {
            $this->errormsg = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_ERRORMSG] = true;
        }
    ...
    public function setSconame($v)
    {
        ...
        if ($this->sconame !== $v) {
            $this->sconame = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SCONAME] = true;
        }
    ...
    public function setShipname($v)
    {
        ...
        if ($this->shipname !== $v) {
            $this->shipname = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPNAME] = true;
        }
    ...
    public function setShipaddress($v)
    {
        ...
        if ($this->shipaddress !== $v) {
            $this->shipaddress = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPADDRESS] = true;
        }
    ...
    public function setShipaddress2($v)
    {
        ...
        if ($this->shipaddress2 !== $v) {
            $this->shipaddress2 = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPADDRESS2] = true;
        }
    ...
    public function setShipcity($v)
    {
        ...
        if ($this->shipcity !== $v) {
            $this->shipcity = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPCITY] = true;
        }
    ...
    public function setShipstate($v)
    {
        ...
        if ($this->shipstate !== $v) {
            $this->shipstate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPSTATE] = true;
        }
    ...
    public function setShipzip($v)
    {
        ...
        if ($this->shipzip !== $v) {
            $this->shipzip = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPZIP] = true;
        }
    ...
    public function setShipcountry($v)
    {
        ...
        if ($this->shipcountry !== $v) {
            $this->shipcountry = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPCOUNTRY] = true;
        }
    ...
    public function setContact($v)
    {
        ...
        if ($this->contact !== $v) {
            $this->contact = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CONTACT] = true;
        }
    ...
    public function setPhintl($v)
    {
        ...
        if ($this->phintl !== $v) {
            $this->phintl = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PHINTL] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PHONE] = true;
        }
    ...
    public function setExtension($v)
    {
        ...
        if ($this->extension !== $v) {
            $this->extension = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_EXTENSION] = true;
        }
    ...
    public function setFaxnbr($v)
    {
        ...
        if ($this->faxnbr !== $v) {
            $this->faxnbr = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_FAXNBR] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_EMAIL] = true;
        }
    ...
    public function setReleasenbr($v)
    {
        ...
        if ($this->releasenbr !== $v) {
            $this->releasenbr = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_RELEASENBR] = true;
        }
    ...
    public function setShipviacd($v)
    {
        ...
        if ($this->shipviacd !== $v) {
            $this->shipviacd = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPVIACD] = true;
        }
    ...
    public function setShipviadesc($v)
    {
        ...
        if ($this->shipviadesc !== $v) {
            $this->shipviadesc = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPVIADESC] = true;
        }
    ...
    public function setPricecode($v)
    {
        ...
        if ($this->pricecode !== $v) {
            $this->pricecode = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PRICECODE] = true;
        }
    ...
    public function setPricecodedesc($v)
    {
        ...
        if ($this->pricecodedesc !== $v) {
            ...
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PRICECODEDESC] = true;
        }
    ...
    public function setPricedisp($v)
    {
        ...
        if ($this->pricedisp !== $v) {
            $this->pricedisp = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PRICEDISP] = true;
        }
    ...
    public function setTaxcode($v)
    {
        ...
        if ($this->taxcode !== $v) {
            $this->taxcode = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TAXCODE] = true;
        }
    ...
    public function setTaxcodedesc($v)
    {
        ...
        if ($this->taxcodedesc !== $v) {
            $this->taxcodedesc = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TAXCODEDESC] = true;
        }
    ...
    public function setTaxcodedisp($v)
    {
        ...
        if ($this->taxcodedisp !== $v) {
            $this->taxcodedisp = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TAXCODEDISP] = true;
        }
    ...
    public function setTermcode($v)
    {
        ...
        if ($this->termcode !== $v) {
            $this->termcode = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TERMCODE] = true;
        }
    ...
    public function setTermtype($v)
    {
        ...
        if ($this->termtype !== $v) {
            $this->termtype = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TERMTYPE] = true;
        }
    ...
    public function setTermcodedesc($v)
    {
        ...
        if ($this->termcodedesc !== $v) {
            $this->termcodedesc = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TERMCODEDESC] = true;
        }
    ...
    public function setRqstdate($v)
    {
        ...
        if ($this->rqstdate !== $v) {
            $this->rqstdate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_RQSTDATE] = true;
        }
    ...
    public function setShipcom($v)
    {
        ...
        if ($this->shipcom !== $v) {
            $this->shipcom = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SHIPCOM] = true;
        }
    ...
    public function setSp1($v)
    {
        ...
        if ($this->sp1 !== $v) {
            $this->sp1 = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP1] = true;
        }
    ...
    public function setSp1name($v)
    {
        ...
        if ($this->sp1name !== $v) {
            $this->sp1name = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP1NAME] = true;
        }
    ...
    public function setSp2($v)
    {
        ...
        if ($this->sp2 !== $v) {
            $this->sp2 = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP2] = true;
        }
    ...
    public function setSp2name($v)
    {
        ...
        if ($this->sp2name !== $v) {
            $this->sp2name = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP2NAME] = true;
        }
    ...
    public function setSp2disp($v)
    {
        ...
        if ($this->sp2disp !== $v) {
            $this->sp2disp = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP2DISP] = true;
        }
    ...
    public function setSp3($v)
    {
        ...
        if ($this->sp3 !== $v) {
            $this->sp3 = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP3] = true;
        }
    ...
    public function setSp3name($v)
    {
        ...
        if ($this->sp3name !== $v) {
            $this->sp3name = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP3NAME] = true;
        }
    ...
    public function setSp3disp($v)
    {
        ...
        if ($this->sp3disp !== $v) {
            $this->sp3disp = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SP3DISP] = true;
        }
    ...
    public function setFob($v)
    {
        ...
        if ($this->fob !== $v) {
            $this->fob = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_FOB] = true;
        }
    ...
    public function setDeliverydesc($v)
    {
        ...
        if ($this->deliverydesc !== $v) {
            $this->deliverydesc = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_DELIVERYDESC] = true;
        }
    ...
    public function setWhse($v)
    {
        ...
        if ($this->whse !== $v) {
            $this->whse = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_WHSE] = true;
        }
    ...
    public function setCardnumber($v)
    {
        ...
        if ($this->cardnumber !== $v) {
            $this->cardnumber = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CARDNUMBER] = true;
        }
    ...
    public function setCardexpire($v)
    {
        ...
        if ($this->cardexpire !== $v) {
            $this->cardexpire = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CARDEXPIRE] = true;
        }
    ...
    public function setCardcode($v)
    {
        ...
        if ($this->cardcode !== $v) {
            $this->cardcode = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CARDCODE] = true;
        }
    ...
    public function setCardapproval($v)
    {
        ...
        if ($this->cardapproval !== $v) {
            $this->cardapproval = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_CARDAPPROVAL] = true;
        }
    ...
    public function setTotalcost($v)
    {
        ...
        if ($this->totalcost !== $v) {
            $this->totalcost = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TOTALCOST] = true;
        }
    ...
    public function setTotaldiscount($v)
    {
        ...
        if ($this->totaldiscount !== $v) {
            ...
            $this->modifiedColumns[SalesOrderEditTableMap::COL_TOTALDISCOUNT] = true;
        }
    ...
    public function setPaymenttype($v)
    {
        ...
        if ($this->paymenttype !== $v) {
            $this->paymenttype = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PAYMENTTYPE] = true;
        }
    ...
    public function setSrcdatefrom($v)
    {
        ...
        if ($this->srcdatefrom !== $v) {
            $this->srcdatefrom = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SRCDATEFROM] = true;
        }
    ...
    public function setSrcdatethru($v)
    {
        ...
        if ($this->srcdatethru !== $v) {
            $this->srcdatethru = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_SRCDATETHRU] = true;
        }
    ...
    public function setBillname($v)
    {
        ...
        if ($this->billname !== $v) {
            $this->billname = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLNAME] = true;
        }
    ...
    public function setBilladdress($v)
    {
        ...
        if ($this->billaddress !== $v) {
            $this->billaddress = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLADDRESS] = true;
        }
    ...
    public function setBilladdress2($v)
    {
        ...
        if ($this->billaddress2 !== $v) {
            $this->billaddress2 = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLADDRESS2] = true;
        }
    ...
    public function setBilladdress3($v)
    {
        ...
        if ($this->billaddress3 !== $v) {
            $this->billaddress3 = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLADDRESS3] = true;
        }
    ...
    public function setBillcountry($v)
    {
        ...
        if ($this->billcountry !== $v) {
            $this->billcountry = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLCOUNTRY] = true;
        }
    ...
    public function setBillcity($v)
    {
        ...
        if ($this->billcity !== $v) {
            $this->billcity = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLCITY] = true;
        }
    ...
    public function setBillstate($v)
    {
        ...
        if ($this->billstate !== $v) {
            $this->billstate = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLSTATE] = true;
        }
    ...
    public function setBillzip($v)
    {
        ...
        if ($this->billzip !== $v) {
            $this->billzip = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_BILLZIP] = true;
        }
    ...
    public function setPrntfmt($v)
    {
        ...
        if ($this->prntfmt !== $v) {
            $this->prntfmt = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PRNTFMT] = true;
        }
    ...
    public function setPrntfmtdisp($v)
    {
        ...
        if ($this->prntfmtdisp !== $v) {
            $this->prntfmtdisp = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_PRNTFMTDISP] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[SalesOrderEditTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : SalesOrderEditTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : SalesOrderEditTableMap::translateFieldName('Recno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : SalesOrderEditTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : SalesOrderEditTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : SalesOrderEditTableMap::translateFieldName('Type', TableMap::TYPE_PHPNAME, $indexType)];
            $this->type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : SalesOrderEditTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : SalesOrderEditTableMap::translateFieldName('Shiptoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shiptoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : SalesOrderEditTableMap::translateFieldName('Custname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : SalesOrderEditTableMap::translateFieldName('Orderno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : SalesOrderEditTableMap::translateFieldName('Custpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custpo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : SalesOrderEditTableMap::translateFieldName('Custref', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : SalesOrderEditTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : SalesOrderEditTableMap::translateFieldName('Orderdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : SalesOrderEditTableMap::translateFieldName('Careof', TableMap::TYPE_PHPNAME, $indexType)];
            $this->careof = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : SalesOrderEditTableMap::translateFieldName('Quotdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : SalesOrderEditTableMap::translateFieldName('Invdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : SalesOrderEditTableMap::translateFieldName('Revdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->revdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : SalesOrderEditTableMap::translateFieldName('Expdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->expdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : SalesOrderEditTableMap::translateFieldName('Hasdocuments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasdocuments = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : SalesOrderEditTableMap::translateFieldName('Hastracking', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hastracking = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : SalesOrderEditTableMap::translateFieldName('Subtotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : SalesOrderEditTableMap::translateFieldName('Salestax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salestax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : SalesOrderEditTableMap::translateFieldName('Freight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : SalesOrderEditTableMap::translateFieldName('Misccost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->misccost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : SalesOrderEditTableMap::translateFieldName('Ordertotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordertotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : SalesOrderEditTableMap::translateFieldName('Hasnotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasnotes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : SalesOrderEditTableMap::translateFieldName('Editord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->editord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : SalesOrderEditTableMap::translateFieldName('Error', TableMap::TYPE_PHPNAME, $indexType)];
            $this->error = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : SalesOrderEditTableMap::translateFieldName('Errormsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->errormsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : SalesOrderEditTableMap::translateFieldName('Sconame', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sconame = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipaddress2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipcity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipstate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipstate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipzip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipzip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipcountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcountry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : SalesOrderEditTableMap::translateFieldName('Contact', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : SalesOrderEditTableMap::translateFieldName('Phintl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phintl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : SalesOrderEditTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : SalesOrderEditTableMap::translateFieldName('Extension', TableMap::TYPE_PHPNAME, $indexType)];
            $this->extension = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : SalesOrderEditTableMap::translateFieldName('Faxnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->faxnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : SalesOrderEditTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : SalesOrderEditTableMap::translateFieldName('Releasenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->releasenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipviacd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviacd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipviadesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviadesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : SalesOrderEditTableMap::translateFieldName('Pricecode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricecode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : SalesOrderEditTableMap::translateFieldName('Pricecodedesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricecodedesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : SalesOrderEditTableMap::translateFieldName('Pricedisp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricedisp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : SalesOrderEditTableMap::translateFieldName('Taxcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : SalesOrderEditTableMap::translateFieldName('Taxcodedesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcodedesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : SalesOrderEditTableMap::translateFieldName('Taxcodedisp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcodedisp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : SalesOrderEditTableMap::translateFieldName('Termcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : SalesOrderEditTableMap::translateFieldName('Termtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : SalesOrderEditTableMap::translateFieldName('Termcodedesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termcodedesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : SalesOrderEditTableMap::translateFieldName('Rqstdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rqstdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : SalesOrderEditTableMap::translateFieldName('Shipcom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp1name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp2name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp2name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp2disp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp2disp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp3name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp3name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : SalesOrderEditTableMap::translateFieldName('Sp3disp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp3disp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : SalesOrderEditTableMap::translateFieldName('Fob', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fob = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : SalesOrderEditTableMap::translateFieldName('Deliverydesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deliverydesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : SalesOrderEditTableMap::translateFieldName('Whse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : SalesOrderEditTableMap::translateFieldName('Cardnumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardnumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : SalesOrderEditTableMap::translateFieldName('Cardexpire', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardexpire = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : SalesOrderEditTableMap::translateFieldName('Cardcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : SalesOrderEditTableMap::translateFieldName('Cardapproval', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardapproval = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : SalesOrderEditTableMap::translateFieldName('Totalcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : SalesOrderEditTableMap::translateFieldName('Totaldiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totaldiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : SalesOrderEditTableMap::translateFieldName('Paymenttype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->paymenttype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : SalesOrderEditTableMap::translateFieldName('Srcdatefrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->srcdatefrom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : SalesOrderEditTableMap::translateFieldName('Srcdatethru', TableMap::TYPE_PHPNAME, $indexType)];
            $this->srcdatethru = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : SalesOrderEditTableMap::translateFieldName('Billname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : SalesOrderEditTableMap::translateFieldName('Billaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : SalesOrderEditTableMap::translateFieldName('Billaddress2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billaddress2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : SalesOrderEditTableMap::translateFieldName('Billaddress3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billaddress3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : SalesOrderEditTableMap::translateFieldName('Billcountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billcountry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : SalesOrderEditTableMap::translateFieldName('Billcity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billcity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : SalesOrderEditTableMap::translateFieldName('Billstate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billstate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : SalesOrderEditTableMap::translateFieldName('Billzip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billzip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 86 + $startcol : SalesOrderEditTableMap::translateFieldName('Prntfmt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prntfmt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 87 + $startcol : SalesOrderEditTableMap::translateFieldName('Prntfmtdisp', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prntfmtdisp = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 88 + $startcol : SalesOrderEditTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 89; // 89 = SalesOrderEditTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\SalesOrderEdit'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildSalesOrderEditQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see SalesOrderEdit::setDeleted()
     * @see SalesOrderEdit::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildSalesOrderEditQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                SalesOrderEditTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_RECNO)) {
            $modifiedColumns[':p' . $index++]  = 'recno';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'type';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPTOID)) {
            $modifiedColumns[':p' . $index++]  = 'shiptoid';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'custname';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ORDERNO)) {
            $modifiedColumns[':p' . $index++]  = 'orderno';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTPO)) {
            $modifiedColumns[':p' . $index++]  = 'custpo';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTREF)) {
            $modifiedColumns[':p' . $index++]  = 'custref';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ORDERDATE)) {
            $modifiedColumns[':p' . $index++]  = 'orderdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CAREOF)) {
            $modifiedColumns[':p' . $index++]  = 'careof';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_QUOTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'quotdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_INVDATE)) {
            $modifiedColumns[':p' . $index++]  = 'invdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'shipdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_REVDATE)) {
            $modifiedColumns[':p' . $index++]  = 'revdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EXPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'expdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_HASDOCUMENTS)) {
            $modifiedColumns[':p' . $index++]  = 'hasdocuments';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_HASTRACKING)) {
            $modifiedColumns[':p' . $index++]  = 'hastracking';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SUBTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'subtotal';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SALESTAX)) {
            $modifiedColumns[':p' . $index++]  = 'salestax';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'freight';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_MISCCOST)) {
            $modifiedColumns[':p' . $index++]  = 'misccost';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ORDERTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'ordertotal';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_HASNOTES)) {
            $modifiedColumns[':p' . $index++]  = 'hasnotes';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EDITORD)) {
            $modifiedColumns[':p' . $index++]  = 'editord';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ERROR)) {
            $modifiedColumns[':p' . $index++]  = 'error';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ERRORMSG)) {
            $modifiedColumns[':p' . $index++]  = 'errormsg';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SCONAME)) {
            $modifiedColumns[':p' . $index++]  = 'sconame';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPNAME)) {
            $modifiedColumns[':p' . $index++]  = 'shipname';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress2';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPCITY)) {
            $modifiedColumns[':p' . $index++]  = 'shipcity';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPSTATE)) {
            $modifiedColumns[':p' . $index++]  = 'shipstate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPZIP)) {
            $modifiedColumns[':p' . $index++]  = 'shipzip';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPCOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'shipcountry';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CONTACT)) {
            $modifiedColumns[':p' . $index++]  = 'contact';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PHINTL)) {
            $modifiedColumns[':p' . $index++]  = 'phintl';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EXTENSION)) {
            $modifiedColumns[':p' . $index++]  = 'extension';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_FAXNBR)) {
            $modifiedColumns[':p' . $index++]  = 'faxnbr';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_RELEASENBR)) {
            $modifiedColumns[':p' . $index++]  = 'releasenbr';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPVIACD)) {
            $modifiedColumns[':p' . $index++]  = 'shipviacd';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPVIADESC)) {
            $modifiedColumns[':p' . $index++]  = 'shipviadesc';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRICECODE)) {
            $modifiedColumns[':p' . $index++]  = 'pricecode';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRICECODEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'pricecodedesc';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRICEDISP)) {
            $modifiedColumns[':p' . $index++]  = 'pricedisp';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TAXCODE)) {
            $modifiedColumns[':p' . $index++]  = 'taxcode';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TAXCODEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'taxcodedesc';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TAXCODEDISP)) {
            $modifiedColumns[':p' . $index++]  = 'taxcodedisp';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TERMCODE)) {
            $modifiedColumns[':p' . $index++]  = 'termcode';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TERMTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'termtype';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TERMCODEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'termcodedesc';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_RQSTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rqstdate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPCOM)) {
            $modifiedColumns[':p' . $index++]  = 'shipcom';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP1)) {
            $modifiedColumns[':p' . $index++]  = 'sp1';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP1NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp1name';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP2)) {
            $modifiedColumns[':p' . $index++]  = 'sp2';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP2NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp2name';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP2DISP)) {
            $modifiedColumns[':p' . $index++]  = 'sp2disp';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP3)) {
            $modifiedColumns[':p' . $index++]  = 'sp3';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP3NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp3name';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP3DISP)) {
            $modifiedColumns[':p' . $index++]  = 'sp3disp';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_FOB)) {
            $modifiedColumns[':p' . $index++]  = 'fob';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_DELIVERYDESC)) {
            $modifiedColumns[':p' . $index++]  = 'deliverydesc';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'whse';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'cardnumber';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDEXPIRE)) {
            $modifiedColumns[':p' . $index++]  = 'cardexpire';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDCODE)) {
            $modifiedColumns[':p' . $index++]  = 'cardcode';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDAPPROVAL)) {
            $modifiedColumns[':p' . $index++]  = 'cardapproval';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TOTALCOST)) {
            $modifiedColumns[':p' . $index++]  = 'totalcost';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TOTALDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'totaldiscount';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PAYMENTTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'paymenttype';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SRCDATEFROM)) {
            $modifiedColumns[':p' . $index++]  = 'srcdatefrom';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SRCDATETHRU)) {
            $modifiedColumns[':p' . $index++]  = 'srcdatethru';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLNAME)) {
            $modifiedColumns[':p' . $index++]  = 'billname';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'billaddress';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'billaddress2';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLADDRESS3)) {
            $modifiedColumns[':p' . $index++]  = 'billaddress3';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLCOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'billcountry';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLCITY)) {
            $modifiedColumns[':p' . $index++]  = 'billcity';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLSTATE)) {
            $modifiedColumns[':p' . $index++]  = 'billstate';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLZIP)) {
            $modifiedColumns[':p' . $index++]  = 'billzip';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRNTFMT)) {
            $modifiedColumns[':p' . $index++]  = 'prntfmt';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRNTFMTDISP)) {
            $modifiedColumns[':p' . $index++]  = 'prntfmtdisp';
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_DUMMY)) {
    ...
    {
        $pos = SalesOrderEditTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['SalesOrderEdit'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['SalesOrderEdit'][$this->hashCode()] = true;
        $keys = SalesOrderEditTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SESSIONID)) {
            $criteria->add(SalesOrderEditTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_RECNO)) {
            $criteria->add(SalesOrderEditTableMap::COL_RECNO, $this->recno);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_DATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TIME)) {
            $criteria->add(SalesOrderEditTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TYPE)) {
            $criteria->add(SalesOrderEditTableMap::COL_TYPE, $this->type);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTID)) {
            $criteria->add(SalesOrderEditTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPTOID)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPTOID, $this->shiptoid);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTNAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_CUSTNAME, $this->custname);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ORDERNO)) {
            $criteria->add(SalesOrderEditTableMap::COL_ORDERNO, $this->orderno);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTPO)) {
            $criteria->add(SalesOrderEditTableMap::COL_CUSTPO, $this->custpo);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CUSTREF)) {
            $criteria->add(SalesOrderEditTableMap::COL_CUSTREF, $this->custref);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_STATUS)) {
            $criteria->add(SalesOrderEditTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ORDERDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_ORDERDATE, $this->orderdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CAREOF)) {
            $criteria->add(SalesOrderEditTableMap::COL_CAREOF, $this->careof);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_QUOTDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_QUOTDATE, $this->quotdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_INVDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_INVDATE, $this->invdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPDATE, $this->shipdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_REVDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_REVDATE, $this->revdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EXPDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_EXPDATE, $this->expdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_HASDOCUMENTS)) {
            $criteria->add(SalesOrderEditTableMap::COL_HASDOCUMENTS, $this->hasdocuments);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_HASTRACKING)) {
            $criteria->add(SalesOrderEditTableMap::COL_HASTRACKING, $this->hastracking);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SUBTOTAL)) {
            $criteria->add(SalesOrderEditTableMap::COL_SUBTOTAL, $this->subtotal);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SALESTAX)) {
            $criteria->add(SalesOrderEditTableMap::COL_SALESTAX, $this->salestax);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_FREIGHT)) {
            $criteria->add(SalesOrderEditTableMap::COL_FREIGHT, $this->freight);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_MISCCOST)) {
            $criteria->add(SalesOrderEditTableMap::COL_MISCCOST, $this->misccost);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ORDERTOTAL)) {
            $criteria->add(SalesOrderEditTableMap::COL_ORDERTOTAL, $this->ordertotal);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_HASNOTES)) {
            $criteria->add(SalesOrderEditTableMap::COL_HASNOTES, $this->hasnotes);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EDITORD)) {
            $criteria->add(SalesOrderEditTableMap::COL_EDITORD, $this->editord);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ERROR)) {
            $criteria->add(SalesOrderEditTableMap::COL_ERROR, $this->error);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_ERRORMSG)) {
            $criteria->add(SalesOrderEditTableMap::COL_ERRORMSG, $this->errormsg);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SCONAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_SCONAME, $this->sconame);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPNAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPNAME, $this->shipname);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPADDRESS)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPADDRESS, $this->shipaddress);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPADDRESS2)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPADDRESS2, $this->shipaddress2);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPCITY)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPCITY, $this->shipcity);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPSTATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPSTATE, $this->shipstate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPZIP)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPZIP, $this->shipzip);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPCOUNTRY)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPCOUNTRY, $this->shipcountry);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CONTACT)) {
            $criteria->add(SalesOrderEditTableMap::COL_CONTACT, $this->contact);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PHINTL)) {
            $criteria->add(SalesOrderEditTableMap::COL_PHINTL, $this->phintl);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PHONE)) {
            $criteria->add(SalesOrderEditTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EXTENSION)) {
            $criteria->add(SalesOrderEditTableMap::COL_EXTENSION, $this->extension);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_FAXNBR)) {
            $criteria->add(SalesOrderEditTableMap::COL_FAXNBR, $this->faxnbr);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_EMAIL)) {
            $criteria->add(SalesOrderEditTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_RELEASENBR)) {
            $criteria->add(SalesOrderEditTableMap::COL_RELEASENBR, $this->releasenbr);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPVIACD)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPVIACD, $this->shipviacd);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPVIADESC)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPVIADESC, $this->shipviadesc);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRICECODE)) {
            $criteria->add(SalesOrderEditTableMap::COL_PRICECODE, $this->pricecode);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRICECODEDESC)) {
            $criteria->add(SalesOrderEditTableMap::COL_PRICECODEDESC, $this->pricecodedesc);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRICEDISP)) {
            $criteria->add(SalesOrderEditTableMap::COL_PRICEDISP, $this->pricedisp);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TAXCODE)) {
            $criteria->add(SalesOrderEditTableMap::COL_TAXCODE, $this->taxcode);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TAXCODEDESC)) {
            $criteria->add(SalesOrderEditTableMap::COL_TAXCODEDESC, $this->taxcodedesc);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TAXCODEDISP)) {
            $criteria->add(SalesOrderEditTableMap::COL_TAXCODEDISP, $this->taxcodedisp);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TERMCODE)) {
            $criteria->add(SalesOrderEditTableMap::COL_TERMCODE, $this->termcode);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TERMTYPE)) {
            $criteria->add(SalesOrderEditTableMap::COL_TERMTYPE, $this->termtype);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TERMCODEDESC)) {
            $criteria->add(SalesOrderEditTableMap::COL_TERMCODEDESC, $this->termcodedesc);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_RQSTDATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_RQSTDATE, $this->rqstdate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SHIPCOM)) {
            $criteria->add(SalesOrderEditTableMap::COL_SHIPCOM, $this->shipcom);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP1)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP1, $this->sp1);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP1NAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP1NAME, $this->sp1name);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP2)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP2, $this->sp2);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP2NAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP2NAME, $this->sp2name);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP2DISP)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP2DISP, $this->sp2disp);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP3)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP3, $this->sp3);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP3NAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP3NAME, $this->sp3name);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SP3DISP)) {
            $criteria->add(SalesOrderEditTableMap::COL_SP3DISP, $this->sp3disp);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_FOB)) {
            $criteria->add(SalesOrderEditTableMap::COL_FOB, $this->fob);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_DELIVERYDESC)) {
            $criteria->add(SalesOrderEditTableMap::COL_DELIVERYDESC, $this->deliverydesc);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_WHSE)) {
            $criteria->add(SalesOrderEditTableMap::COL_WHSE, $this->whse);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDNUMBER)) {
            $criteria->add(SalesOrderEditTableMap::COL_CARDNUMBER, $this->cardnumber);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDEXPIRE)) {
            $criteria->add(SalesOrderEditTableMap::COL_CARDEXPIRE, $this->cardexpire);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDCODE)) {
            $criteria->add(SalesOrderEditTableMap::COL_CARDCODE, $this->cardcode);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_CARDAPPROVAL)) {
            $criteria->add(SalesOrderEditTableMap::COL_CARDAPPROVAL, $this->cardapproval);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TOTALCOST)) {
            $criteria->add(SalesOrderEditTableMap::COL_TOTALCOST, $this->totalcost);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_TOTALDISCOUNT)) {
            $criteria->add(SalesOrderEditTableMap::COL_TOTALDISCOUNT, $this->totaldiscount);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PAYMENTTYPE)) {
            $criteria->add(SalesOrderEditTableMap::COL_PAYMENTTYPE, $this->paymenttype);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SRCDATEFROM)) {
            $criteria->add(SalesOrderEditTableMap::COL_SRCDATEFROM, $this->srcdatefrom);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_SRCDATETHRU)) {
            $criteria->add(SalesOrderEditTableMap::COL_SRCDATETHRU, $this->srcdatethru);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLNAME)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLNAME, $this->billname);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLADDRESS)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLADDRESS, $this->billaddress);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLADDRESS2)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLADDRESS2, $this->billaddress2);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLADDRESS3)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLADDRESS3, $this->billaddress3);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLCOUNTRY)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLCOUNTRY, $this->billcountry);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLCITY)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLCITY, $this->billcity);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLSTATE)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLSTATE, $this->billstate);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_BILLZIP)) {
            $criteria->add(SalesOrderEditTableMap::COL_BILLZIP, $this->billzip);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRNTFMT)) {
            $criteria->add(SalesOrderEditTableMap::COL_PRNTFMT, $this->prntfmt);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_PRNTFMTDISP)) {
            $criteria->add(SalesOrderEditTableMap::COL_PRNTFMTDISP, $this->prntfmtdisp);
        }
        if ($this->isColumnModified(SalesOrderEditTableMap::COL_DUMMY)) {
            $criteria->add(SalesOrderEditTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildSalesOrderEditQuery::create();
        $criteria->add(SalesOrderEditTableMap::COL_SESSIONID, $this->sessionid);
        $criteria->add(SalesOrderEditTableMap::COL_RECNO, $this->recno);
        $criteria->add(SalesOrderEditTableMap::COL_ORDERNO, $this->orderno);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \SalesOrderEdit (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \SalesOrderEdit Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(SalesOrderEditTableMap::DEFAULT_STRING_FORMAT);
    }
