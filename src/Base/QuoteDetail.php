...
abstract class QuoteDetail implements ActiveRecordInterface
{
    ...
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecno($v)
    {
        ...
        if ($this->recno !== $v) {
            $this->recno = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_RECNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_TIME] = true;
        }
    ...
    public function setQuotenbr($v)
    {
        ...
        if ($this->quotenbr !== $v) {
            $this->quotenbr = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_QUOTENBR] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_CUSTID] = true;
        }
    ...
    public function setLinenbr($v)
    {
        ...
        if ($this->linenbr !== $v) {
            $this->linenbr = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_LINENBR] = true;
        }
    ...
    public function setSublinenbr($v)
    {
        ...
        if ($this->sublinenbr !== $v) {
            $this->sublinenbr = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_SUBLINENBR] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ITEMID] = true;
        }
    ...
    public function setDesc1($v)
    {
        ...
        if ($this->desc1 !== $v) {
            $this->desc1 = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_DESC1] = true;
        }
    ...
    public function setDesc2($v)
    {
        ...
        if ($this->desc2 !== $v) {
            $this->desc2 = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_DESC2] = true;
        }
    ...
    public function setCustitemid($v)
    {
        ...
        if ($this->custitemid !== $v) {
            $this->custitemid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_CUSTITEMID] = true;
        }
    ...
    public function setVendorid($v)
    {
        ...
        if ($this->vendorid !== $v) {
            $this->vendorid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_VENDORID] = true;
        }
    ...
    public function setVendoritemid($v)
    {
        ...
        if ($this->vendoritemid !== $v) {
            $this->vendoritemid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_VENDORITEMID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_STATUS] = true;
        }
    ...
    public function setLostreason($v)
    {
        ...
        if ($this->lostreason !== $v) {
            $this->lostreason = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_LOSTREASON] = true;
        }
    ...
    public function setLostdate($v)
    {
        ...
        if ($this->lostdate !== $v) {
            $this->lostdate = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_LOSTDATE] = true;
        }
    ...
    public function setKititemflag($v)
    {
        ...
        if ($this->kititemflag !== $v) {
            $this->kititemflag = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_KITITEMFLAG] = true;
        }
    ...
    public function setHasnotes($v)
    {
        ...
        if ($this->hasnotes !== $v) {
            $this->hasnotes = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_HASNOTES] = true;
        }
    ...
    public function setVenddetail($v)
    {
        ...
        if ($this->venddetail !== $v) {
            $this->venddetail = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_VENDDETAIL] = true;
        }
    ...
    public function setRshipdate($v)
    {
        ...
        if ($this->rshipdate !== $v) {
            $this->rshipdate = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_RSHIPDATE] = true;
        }
    ...
    public function setLeaddays($v)
    {
        ...
        if ($this->leaddays !== $v) {
            $this->leaddays = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_LEADDAYS] = true;
        }
    ...
    public function setTaxcode($v)
    {
        ...
        if ($this->taxcode !== $v) {
            $this->taxcode = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_TAXCODE] = true;
        }
    ...
    public function setOrdrqty($v)
    {
        ...
        if ($this->ordrqty !== $v) {
            $this->ordrqty = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ORDRQTY] = true;
        }
    ...
    public function setOrdrprice($v)
    {
        ...
        if ($this->ordrprice !== $v) {
            $this->ordrprice = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ORDRPRICE] = true;
        }
    ...
    public function setOrdrcost($v)
    {
        ...
        if ($this->ordrcost !== $v) {
            $this->ordrcost = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ORDRCOST] = true;
        }
    ...
    public function setOrdrtotalprice($v)
    {
        ...
        if ($this->ordrtotalprice !== $v) {
            ...
            $this->modifiedColumns[QuoteDetailTableMap::COL_ORDRTOTALPRICE] = true;
        }
    ...
    public function setOrdrtotalcost($v)
    {
        ...
        if ($this->ordrtotalcost !== $v) {
            ...
            $this->modifiedColumns[QuoteDetailTableMap::COL_ORDRTOTALCOST] = true;
        }
    ...
    public function setUom($v)
    {
        ...
        if ($this->uom !== $v) {
            $this->uom = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_UOM] = true;
        }
    ...
    public function setCostuom($v)
    {
        ...
        if ($this->costuom !== $v) {
            $this->costuom = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_COSTUOM] = true;
        }
    ...
    public function setWhse($v)
    {
        ...
        if ($this->whse !== $v) {
            $this->whse = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_WHSE] = true;
        }
    ...
    public function setListprice($v)
    {
        ...
        if ($this->listprice !== $v) {
            $this->listprice = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_LISTPRICE] = true;
        }
    ...
    public function setStancost($v)
    {
        ...
        if ($this->stancost !== $v) {
            $this->stancost = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_STANCOST] = true;
        }
    ...
    public function setQuotind($v)
    {
        ...
        if ($this->quotind !== $v) {
            $this->quotind = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_QUOTIND] = true;
        }
    ...
    public function setQuotqty($v)
    {
        ...
        if ($this->quotqty !== $v) {
            $this->quotqty = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_QUOTQTY] = true;
        }
    ...
    public function setQuotprice($v)
    {
        ...
        if ($this->quotprice !== $v) {
            $this->quotprice = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_QUOTPRICE] = true;
        }
    ...
    public function setQuotcost($v)
    {
        ...
        if ($this->quotcost !== $v) {
            $this->quotcost = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_QUOTCOST] = true;
        }
    ...
    public function setQuotmkupmarg($v)
    {
        ...
        if ($this->quotmkupmarg !== $v) {
            $this->quotmkupmarg = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_QUOTMKUPMARG] = true;
        }
    ...
    public function setDiscpct($v)
    {
        ...
        if ($this->discpct !== $v) {
            $this->discpct = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_DISCPCT] = true;
        }
    ...
    public function setSpcord($v)
    {
        ...
        if ($this->spcord !== $v) {
            $this->spcord = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_SPCORD] = true;
        }
    ...
    public function setError($v)
    {
        ...
        if ($this->error !== $v) {
            $this->error = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ERROR] = true;
        }
    ...
    public function setErrormsg($v)
    {
        ...
        if ($this->errormsg !== $v) {
            $this->errormsg = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ERRORMSG] = true;
        }
    ...
    public function setMinprice($v)
    {
        ...
        if ($this->minprice !== $v) {
            $this->minprice = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_MINPRICE] = true;
        }
    ...
    public function setNsitemgroup($v)
    {
        ...
        if ($this->nsitemgroup !== $v) {
            $this->nsitemgroup = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_NSITEMGROUP] = true;
        }
    ...
    public function setShipfromid($v)
    {
        ...
        if ($this->shipfromid !== $v) {
            $this->shipfromid = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_SHIPFROMID] = true;
        }
    ...
    public function setItemtype($v)
    {
        ...
        if ($this->itemtype !== $v) {
            $this->itemtype = $v;
            $this->modifiedColumns[QuoteDetailTableMap::COL_ITEMTYPE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : QuoteDetailTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : QuoteDetailTableMap::translateFieldName('Recno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : QuoteDetailTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : QuoteDetailTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : QuoteDetailTableMap::translateFieldName('Quotenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : QuoteDetailTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : QuoteDetailTableMap::translateFieldName('Linenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->linenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : QuoteDetailTableMap::translateFieldName('Sublinenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sublinenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : QuoteDetailTableMap::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : QuoteDetailTableMap::translateFieldName('Desc1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : QuoteDetailTableMap::translateFieldName('Desc2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : QuoteDetailTableMap::translateFieldName('Custitemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custitemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : QuoteDetailTableMap::translateFieldName('Vendorid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendorid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : QuoteDetailTableMap::translateFieldName('Vendoritemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vendoritemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : QuoteDetailTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : QuoteDetailTableMap::translateFieldName('Lostreason', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lostreason = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : QuoteDetailTableMap::translateFieldName('Lostdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lostdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : QuoteDetailTableMap::translateFieldName('Kititemflag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->kititemflag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : QuoteDetailTableMap::translateFieldName('Hasnotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasnotes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : QuoteDetailTableMap::translateFieldName('Venddetail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->venddetail = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : QuoteDetailTableMap::translateFieldName('Rshipdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rshipdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : QuoteDetailTableMap::translateFieldName('Leaddays', TableMap::TYPE_PHPNAME, $indexType)];
            $this->leaddays = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : QuoteDetailTableMap::translateFieldName('Taxcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : QuoteDetailTableMap::translateFieldName('Ordrqty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordrqty = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : QuoteDetailTableMap::translateFieldName('Ordrprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordrprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : QuoteDetailTableMap::translateFieldName('Ordrcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordrcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : QuoteDetailTableMap::translateFieldName('Ordrtotalprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordrtotalprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : QuoteDetailTableMap::translateFieldName('Ordrtotalcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordrtotalcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : QuoteDetailTableMap::translateFieldName('Uom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : QuoteDetailTableMap::translateFieldName('Costuom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->costuom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : QuoteDetailTableMap::translateFieldName('Whse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : QuoteDetailTableMap::translateFieldName('Listprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->listprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : QuoteDetailTableMap::translateFieldName('Stancost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->stancost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : QuoteDetailTableMap::translateFieldName('Quotind', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotind = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : QuoteDetailTableMap::translateFieldName('Quotqty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotqty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : QuoteDetailTableMap::translateFieldName('Quotprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : QuoteDetailTableMap::translateFieldName('Quotcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : QuoteDetailTableMap::translateFieldName('Quotmkupmarg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotmkupmarg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : QuoteDetailTableMap::translateFieldName('Discpct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discpct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : QuoteDetailTableMap::translateFieldName('Spcord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->spcord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : QuoteDetailTableMap::translateFieldName('Error', TableMap::TYPE_PHPNAME, $indexType)];
            $this->error = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : QuoteDetailTableMap::translateFieldName('Errormsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->errormsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : QuoteDetailTableMap::translateFieldName('Minprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->minprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : QuoteDetailTableMap::translateFieldName('Nsitemgroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nsitemgroup = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : QuoteDetailTableMap::translateFieldName('Shipfromid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipfromid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : QuoteDetailTableMap::translateFieldName('Itemtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : QuoteDetailTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 47; // 47 = QuoteDetailTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_RECNO)) {
            $modifiedColumns[':p' . $index++]  = 'recno';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTENBR)) {
            $modifiedColumns[':p' . $index++]  = 'quotenbr';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LINENBR)) {
            $modifiedColumns[':p' . $index++]  = 'linenbr';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SUBLINENBR)) {
            $modifiedColumns[':p' . $index++]  = 'sublinenbr';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'itemid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DESC1)) {
            $modifiedColumns[':p' . $index++]  = 'desc1';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DESC2)) {
            $modifiedColumns[':p' . $index++]  = 'desc2';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_CUSTITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'custitemid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_VENDORID)) {
            $modifiedColumns[':p' . $index++]  = 'vendorid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_VENDORITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'vendoritemid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LOSTREASON)) {
            $modifiedColumns[':p' . $index++]  = 'lostreason';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LOSTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'lostdate';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_KITITEMFLAG)) {
            $modifiedColumns[':p' . $index++]  = 'kititemflag';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_HASNOTES)) {
            $modifiedColumns[':p' . $index++]  = 'hasnotes';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_VENDDETAIL)) {
            $modifiedColumns[':p' . $index++]  = 'venddetail';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_RSHIPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rshipdate';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LEADDAYS)) {
            $modifiedColumns[':p' . $index++]  = 'leaddays';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_TAXCODE)) {
            $modifiedColumns[':p' . $index++]  = 'taxcode';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRQTY)) {
            $modifiedColumns[':p' . $index++]  = 'ordrqty';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'ordrprice';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRCOST)) {
            $modifiedColumns[':p' . $index++]  = 'ordrcost';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRTOTALPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'ordrtotalprice';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRTOTALCOST)) {
            $modifiedColumns[':p' . $index++]  = 'ordrtotalcost';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_UOM)) {
            $modifiedColumns[':p' . $index++]  = 'uom';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_COSTUOM)) {
            $modifiedColumns[':p' . $index++]  = 'costuom';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'whse';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LISTPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'listprice';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_STANCOST)) {
            $modifiedColumns[':p' . $index++]  = 'stancost';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTIND)) {
            $modifiedColumns[':p' . $index++]  = 'quotind';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTQTY)) {
            $modifiedColumns[':p' . $index++]  = 'quotqty';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'quotprice';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTCOST)) {
            $modifiedColumns[':p' . $index++]  = 'quotcost';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTMKUPMARG)) {
            $modifiedColumns[':p' . $index++]  = 'quotmkupmarg';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DISCPCT)) {
            $modifiedColumns[':p' . $index++]  = 'discpct';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SPCORD)) {
            $modifiedColumns[':p' . $index++]  = 'spcord';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ERROR)) {
            $modifiedColumns[':p' . $index++]  = 'error';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ERRORMSG)) {
            $modifiedColumns[':p' . $index++]  = 'errormsg';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_MINPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'minprice';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_NSITEMGROUP)) {
            $modifiedColumns[':p' . $index++]  = 'nsitemgroup';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SHIPFROMID)) {
            $modifiedColumns[':p' . $index++]  = 'shipfromid';
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ITEMTYPE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SESSIONID)) {
            $criteria->add(QuoteDetailTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_RECNO)) {
            $criteria->add(QuoteDetailTableMap::COL_RECNO, $this->recno);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DATE)) {
            $criteria->add(QuoteDetailTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_TIME)) {
            $criteria->add(QuoteDetailTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTENBR)) {
            $criteria->add(QuoteDetailTableMap::COL_QUOTENBR, $this->quotenbr);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_CUSTID)) {
            $criteria->add(QuoteDetailTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LINENBR)) {
            $criteria->add(QuoteDetailTableMap::COL_LINENBR, $this->linenbr);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SUBLINENBR)) {
            $criteria->add(QuoteDetailTableMap::COL_SUBLINENBR, $this->sublinenbr);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ITEMID)) {
            $criteria->add(QuoteDetailTableMap::COL_ITEMID, $this->itemid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DESC1)) {
            $criteria->add(QuoteDetailTableMap::COL_DESC1, $this->desc1);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DESC2)) {
            $criteria->add(QuoteDetailTableMap::COL_DESC2, $this->desc2);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_CUSTITEMID)) {
            $criteria->add(QuoteDetailTableMap::COL_CUSTITEMID, $this->custitemid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_VENDORID)) {
            $criteria->add(QuoteDetailTableMap::COL_VENDORID, $this->vendorid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_VENDORITEMID)) {
            $criteria->add(QuoteDetailTableMap::COL_VENDORITEMID, $this->vendoritemid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_STATUS)) {
            $criteria->add(QuoteDetailTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LOSTREASON)) {
            $criteria->add(QuoteDetailTableMap::COL_LOSTREASON, $this->lostreason);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LOSTDATE)) {
            $criteria->add(QuoteDetailTableMap::COL_LOSTDATE, $this->lostdate);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_KITITEMFLAG)) {
            $criteria->add(QuoteDetailTableMap::COL_KITITEMFLAG, $this->kititemflag);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_HASNOTES)) {
            $criteria->add(QuoteDetailTableMap::COL_HASNOTES, $this->hasnotes);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_VENDDETAIL)) {
            $criteria->add(QuoteDetailTableMap::COL_VENDDETAIL, $this->venddetail);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_RSHIPDATE)) {
            $criteria->add(QuoteDetailTableMap::COL_RSHIPDATE, $this->rshipdate);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LEADDAYS)) {
            $criteria->add(QuoteDetailTableMap::COL_LEADDAYS, $this->leaddays);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_TAXCODE)) {
            $criteria->add(QuoteDetailTableMap::COL_TAXCODE, $this->taxcode);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRQTY)) {
            $criteria->add(QuoteDetailTableMap::COL_ORDRQTY, $this->ordrqty);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRPRICE)) {
            $criteria->add(QuoteDetailTableMap::COL_ORDRPRICE, $this->ordrprice);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRCOST)) {
            $criteria->add(QuoteDetailTableMap::COL_ORDRCOST, $this->ordrcost);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRTOTALPRICE)) {
            $criteria->add(QuoteDetailTableMap::COL_ORDRTOTALPRICE, $this->ordrtotalprice);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ORDRTOTALCOST)) {
            $criteria->add(QuoteDetailTableMap::COL_ORDRTOTALCOST, $this->ordrtotalcost);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_UOM)) {
            $criteria->add(QuoteDetailTableMap::COL_UOM, $this->uom);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_COSTUOM)) {
            $criteria->add(QuoteDetailTableMap::COL_COSTUOM, $this->costuom);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_WHSE)) {
            $criteria->add(QuoteDetailTableMap::COL_WHSE, $this->whse);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_LISTPRICE)) {
            $criteria->add(QuoteDetailTableMap::COL_LISTPRICE, $this->listprice);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_STANCOST)) {
            $criteria->add(QuoteDetailTableMap::COL_STANCOST, $this->stancost);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTIND)) {
            $criteria->add(QuoteDetailTableMap::COL_QUOTIND, $this->quotind);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTQTY)) {
            $criteria->add(QuoteDetailTableMap::COL_QUOTQTY, $this->quotqty);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTPRICE)) {
            $criteria->add(QuoteDetailTableMap::COL_QUOTPRICE, $this->quotprice);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTCOST)) {
            $criteria->add(QuoteDetailTableMap::COL_QUOTCOST, $this->quotcost);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_QUOTMKUPMARG)) {
            $criteria->add(QuoteDetailTableMap::COL_QUOTMKUPMARG, $this->quotmkupmarg);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DISCPCT)) {
            $criteria->add(QuoteDetailTableMap::COL_DISCPCT, $this->discpct);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SPCORD)) {
            $criteria->add(QuoteDetailTableMap::COL_SPCORD, $this->spcord);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ERROR)) {
            $criteria->add(QuoteDetailTableMap::COL_ERROR, $this->error);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ERRORMSG)) {
            $criteria->add(QuoteDetailTableMap::COL_ERRORMSG, $this->errormsg);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_MINPRICE)) {
            $criteria->add(QuoteDetailTableMap::COL_MINPRICE, $this->minprice);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_NSITEMGROUP)) {
            $criteria->add(QuoteDetailTableMap::COL_NSITEMGROUP, $this->nsitemgroup);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_SHIPFROMID)) {
            $criteria->add(QuoteDetailTableMap::COL_SHIPFROMID, $this->shipfromid);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_ITEMTYPE)) {
            $criteria->add(QuoteDetailTableMap::COL_ITEMTYPE, $this->itemtype);
        }
        if ($this->isColumnModified(QuoteDetailTableMap::COL_DUMMY)) {
