...
abstract class Quote implements ActiveRecordInterface
{
    ...
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecno($v)
    {
        ...
        if ($this->recno !== $v) {
            $this->recno = $v;
            $this->modifiedColumns[QuoteTableMap::COL_RECNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[QuoteTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[QuoteTableMap::COL_TIME] = true;
        }
    ...
    public function setQuotnbr($v)
    {
        ...
        if ($this->quotnbr !== $v) {
            $this->quotnbr = $v;
            $this->modifiedColumns[QuoteTableMap::COL_QUOTNBR] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[QuoteTableMap::COL_STATUS] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[QuoteTableMap::COL_CUSTID] = true;
        }
    ...
    public function setBillname($v)
    {
        ...
        if ($this->billname !== $v) {
            $this->billname = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLNAME] = true;
        }
    ...
    public function setBilladdress($v)
    {
        ...
        if ($this->billaddress !== $v) {
            $this->billaddress = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLADDRESS] = true;
        }
    ...
    public function setBilladdress2($v)
    {
        ...
        if ($this->billaddress2 !== $v) {
            $this->billaddress2 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLADDRESS2] = true;
        }
    ...
    public function setBilladdress3($v)
    {
        ...
        if ($this->billaddress3 !== $v) {
            $this->billaddress3 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLADDRESS3] = true;
        }
    ...
    public function setBillcountry($v)
    {
        ...
        if ($this->billcountry !== $v) {
            $this->billcountry = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLCOUNTRY] = true;
        }
    ...
    public function setBillcity($v)
    {
        ...
        if ($this->billcity !== $v) {
            $this->billcity = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLCITY] = true;
        }
    ...
    public function setBillstate($v)
    {
        ...
        if ($this->billstate !== $v) {
            $this->billstate = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLSTATE] = true;
        }
    ...
    public function setBillzip($v)
    {
        ...
        if ($this->billzip !== $v) {
            $this->billzip = $v;
            $this->modifiedColumns[QuoteTableMap::COL_BILLZIP] = true;
        }
    ...
    public function setShiptoid($v)
    {
        ...
        if ($this->shiptoid !== $v) {
            $this->shiptoid = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPTOID] = true;
        }
    ...
    public function setShipname($v)
    {
        ...
        if ($this->shipname !== $v) {
            $this->shipname = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPNAME] = true;
        }
    ...
    public function setShipaddress($v)
    {
        ...
        if ($this->shipaddress !== $v) {
            $this->shipaddress = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPADDRESS] = true;
        }
    ...
    public function setShipaddress2($v)
    {
        ...
        if ($this->shipaddress2 !== $v) {
            $this->shipaddress2 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPADDRESS2] = true;
        }
    ...
    public function setShipaddress3($v)
    {
        ...
        if ($this->shipaddress3 !== $v) {
            $this->shipaddress3 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPADDRESS3] = true;
        }
    ...
    public function setShipcountry($v)
    {
        ...
        if ($this->shipcountry !== $v) {
            $this->shipcountry = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPCOUNTRY] = true;
        }
    ...
    public function setShipcity($v)
    {
        ...
        if ($this->shipcity !== $v) {
            $this->shipcity = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPCITY] = true;
        }
    ...
    public function setShipstate($v)
    {
        ...
        if ($this->shipstate !== $v) {
            $this->shipstate = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPSTATE] = true;
        }
    ...
    public function setShipzip($v)
    {
        ...
        if ($this->shipzip !== $v) {
            $this->shipzip = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPZIP] = true;
        }
    ...
    public function setContact($v)
    {
        ...
        if ($this->contact !== $v) {
            $this->contact = $v;
            $this->modifiedColumns[QuoteTableMap::COL_CONTACT] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[QuoteTableMap::COL_PHONE] = true;
        }
    ...
    public function setFaxnbr($v)
    {
        ...
        if ($this->faxnbr !== $v) {
            $this->faxnbr = $v;
            $this->modifiedColumns[QuoteTableMap::COL_FAXNBR] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[QuoteTableMap::COL_EMAIL] = true;
        }
    ...
    public function setCareof($v)
    {
        ...
        if ($this->careof !== $v) {
            $this->careof = $v;
            $this->modifiedColumns[QuoteTableMap::COL_CAREOF] = true;
        }
    ...
    public function setQuotdate($v)
    {
        ...
        if ($this->quotdate !== $v) {
            $this->quotdate = $v;
            $this->modifiedColumns[QuoteTableMap::COL_QUOTDATE] = true;
        }
    ...
    public function setRevdate($v)
    {
        ...
        if ($this->revdate !== $v) {
            $this->revdate = $v;
            $this->modifiedColumns[QuoteTableMap::COL_REVDATE] = true;
        }
    ...
    public function setExpdate($v)
    {
        ...
        if ($this->expdate !== $v) {
            $this->expdate = $v;
            $this->modifiedColumns[QuoteTableMap::COL_EXPDATE] = true;
        }
    ...
    public function setPricecode($v)
    {
        ...
        if ($this->pricecode !== $v) {
            $this->pricecode = $v;
            $this->modifiedColumns[QuoteTableMap::COL_PRICECODE] = true;
        }
    ...
    public function setPricecodedesc($v)
    {
        ...
        if ($this->pricecodedesc !== $v) {
            ...
            $this->modifiedColumns[QuoteTableMap::COL_PRICECODEDESC] = true;
        }
    ...
    public function setTaxcode($v)
    {
        ...
        if ($this->taxcode !== $v) {
            $this->taxcode = $v;
            $this->modifiedColumns[QuoteTableMap::COL_TAXCODE] = true;
        }
    ...
    public function setTaxcodedesc($v)
    {
        ...
        if ($this->taxcodedesc !== $v) {
            $this->taxcodedesc = $v;
            $this->modifiedColumns[QuoteTableMap::COL_TAXCODEDESC] = true;
        }
    ...
    public function setTermcode($v)
    {
        ...
        if ($this->termcode !== $v) {
            $this->termcode = $v;
            $this->modifiedColumns[QuoteTableMap::COL_TERMCODE] = true;
        }
    ...
    public function setTermcodedesc($v)
    {
        ...
        if ($this->termcodedesc !== $v) {
            $this->termcodedesc = $v;
            $this->modifiedColumns[QuoteTableMap::COL_TERMCODEDESC] = true;
        }
    ...
    public function setShipviacd($v)
    {
        ...
        if ($this->shipviacd !== $v) {
            $this->shipviacd = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPVIACD] = true;
        }
    ...
    public function setShipviadesc($v)
    {
        ...
        if ($this->shipviadesc !== $v) {
            $this->shipviadesc = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SHIPVIADESC] = true;
        }
    ...
    public function setSp1($v)
    {
        ...
        if ($this->sp1 !== $v) {
            $this->sp1 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP1] = true;
        }
    ...
    public function setSp1pct($v)
    {
        ...
        if ($this->sp1pct !== $v) {
            $this->sp1pct = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP1PCT] = true;
        }
    ...
    public function setSp1name($v)
    {
        ...
        if ($this->sp1name !== $v) {
            $this->sp1name = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP1NAME] = true;
        }
    ...
    public function setSp2($v)
    {
        ...
        if ($this->sp2 !== $v) {
            $this->sp2 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP2] = true;
        }
    ...
    public function setSp2pct($v)
    {
        ...
        if ($this->sp2pct !== $v) {
            $this->sp2pct = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP2PCT] = true;
        }
    ...
    public function setSp2name($v)
    {
        ...
        if ($this->sp2name !== $v) {
            $this->sp2name = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP2NAME] = true;
        }
    ...
    public function setSp3($v)
    {
        ...
        if ($this->sp3 !== $v) {
            $this->sp3 = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP3] = true;
        }
    ...
    public function setSp3pct($v)
    {
        ...
        if ($this->sp3pct !== $v) {
            $this->sp3pct = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP3PCT] = true;
        }
    ...
    public function setSp3name($v)
    {
        ...
        if ($this->sp3name !== $v) {
            $this->sp3name = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SP3NAME] = true;
        }
    ...
    public function setFob($v)
    {
        ...
        if ($this->fob !== $v) {
            $this->fob = $v;
            $this->modifiedColumns[QuoteTableMap::COL_FOB] = true;
        }
    ...
    public function setDeliverydesc($v)
    {
        ...
        if ($this->deliverydesc !== $v) {
            $this->deliverydesc = $v;
            $this->modifiedColumns[QuoteTableMap::COL_DELIVERYDESC] = true;
        }
    ...
    public function setWhse($v)
    {
        ...
        if ($this->whse !== $v) {
            $this->whse = $v;
            $this->modifiedColumns[QuoteTableMap::COL_WHSE] = true;
        }
    ...
    public function setCustpo($v)
    {
        ...
        if ($this->custpo !== $v) {
            $this->custpo = $v;
            $this->modifiedColumns[QuoteTableMap::COL_CUSTPO] = true;
        }
    ...
    public function setCustref($v)
    {
        ...
        if ($this->custref !== $v) {
            $this->custref = $v;
            $this->modifiedColumns[QuoteTableMap::COL_CUSTREF] = true;
        }
    ...
    public function setHasnotes($v)
    {
        ...
        if ($this->hasnotes !== $v) {
            $this->hasnotes = $v;
            $this->modifiedColumns[QuoteTableMap::COL_HASNOTES] = true;
        }
    ...
    public function setError($v)
    {
        ...
        if ($this->error !== $v) {
            $this->error = $v;
            $this->modifiedColumns[QuoteTableMap::COL_ERROR] = true;
        }
    ...
    public function setErrormsg($v)
    {
        ...
        if ($this->errormsg !== $v) {
            $this->errormsg = $v;
            $this->modifiedColumns[QuoteTableMap::COL_ERRORMSG] = true;
        }
    ...
    public function setSubtotal($v)
    {
        ...
        if ($this->subtotal !== $v) {
            $this->subtotal = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SUBTOTAL] = true;
        }
    ...
    public function setSalestax($v)
    {
        ...
        if ($this->salestax !== $v) {
            $this->salestax = $v;
            $this->modifiedColumns[QuoteTableMap::COL_SALESTAX] = true;
        }
    ...
    public function setFreight($v)
    {
        ...
        if ($this->freight !== $v) {
            $this->freight = $v;
            $this->modifiedColumns[QuoteTableMap::COL_FREIGHT] = true;
        }
    ...
    public function setMisccost($v)
    {
        ...
        if ($this->misccost !== $v) {
            $this->misccost = $v;
            $this->modifiedColumns[QuoteTableMap::COL_MISCCOST] = true;
        }
    ...
    public function setOrdertotal($v)
    {
        ...
        if ($this->ordertotal !== $v) {
            $this->ordertotal = $v;
            $this->modifiedColumns[QuoteTableMap::COL_ORDERTOTAL] = true;
        }
    ...
    public function setCostTotal($v)
    {
        ...
        if ($this->cost_total !== $v) {
            $this->cost_total = $v;
            $this->modifiedColumns[QuoteTableMap::COL_COST_TOTAL] = true;
        }
    ...
    public function setMarginAmt($v)
    {
        ...
        if ($this->margin_amt !== $v) {
            $this->margin_amt = $v;
            $this->modifiedColumns[QuoteTableMap::COL_MARGIN_AMT] = true;
        }
    ...
    public function setMarginPct($v)
    {
        ...
        if ($this->margin_pct !== $v) {
            $this->margin_pct = $v;
            $this->modifiedColumns[QuoteTableMap::COL_MARGIN_PCT] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : QuoteTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : QuoteTableMap::translateFieldName('Recno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : QuoteTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : QuoteTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : QuoteTableMap::translateFieldName('Quotnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : QuoteTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : QuoteTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : QuoteTableMap::translateFieldName('Billname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : QuoteTableMap::translateFieldName('Billaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : QuoteTableMap::translateFieldName('Billaddress2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billaddress2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : QuoteTableMap::translateFieldName('Billaddress3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billaddress3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : QuoteTableMap::translateFieldName('Billcountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billcountry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : QuoteTableMap::translateFieldName('Billcity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billcity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : QuoteTableMap::translateFieldName('Billstate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billstate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : QuoteTableMap::translateFieldName('Billzip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billzip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : QuoteTableMap::translateFieldName('Shiptoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shiptoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : QuoteTableMap::translateFieldName('Shipname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : QuoteTableMap::translateFieldName('Shipaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : QuoteTableMap::translateFieldName('Shipaddress2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : QuoteTableMap::translateFieldName('Shipaddress3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : QuoteTableMap::translateFieldName('Shipcountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcountry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : QuoteTableMap::translateFieldName('Shipcity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : QuoteTableMap::translateFieldName('Shipstate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipstate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : QuoteTableMap::translateFieldName('Shipzip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipzip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : QuoteTableMap::translateFieldName('Contact', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : QuoteTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : QuoteTableMap::translateFieldName('Faxnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->faxnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : QuoteTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : QuoteTableMap::translateFieldName('Careof', TableMap::TYPE_PHPNAME, $indexType)];
            $this->careof = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : QuoteTableMap::translateFieldName('Quotdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->quotdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : QuoteTableMap::translateFieldName('Revdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->revdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : QuoteTableMap::translateFieldName('Expdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->expdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : QuoteTableMap::translateFieldName('Pricecode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricecode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : QuoteTableMap::translateFieldName('Pricecodedesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pricecodedesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : QuoteTableMap::translateFieldName('Taxcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : QuoteTableMap::translateFieldName('Taxcodedesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taxcodedesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : QuoteTableMap::translateFieldName('Termcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : QuoteTableMap::translateFieldName('Termcodedesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termcodedesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : QuoteTableMap::translateFieldName('Shipviacd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviacd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : QuoteTableMap::translateFieldName('Shipviadesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviadesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : QuoteTableMap::translateFieldName('Sp1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : QuoteTableMap::translateFieldName('Sp1pct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : QuoteTableMap::translateFieldName('Sp1name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : QuoteTableMap::translateFieldName('Sp2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : QuoteTableMap::translateFieldName('Sp2pct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp2pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : QuoteTableMap::translateFieldName('Sp2name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp2name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : QuoteTableMap::translateFieldName('Sp3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : QuoteTableMap::translateFieldName('Sp3pct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp3pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : QuoteTableMap::translateFieldName('Sp3name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp3name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : QuoteTableMap::translateFieldName('Fob', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fob = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : QuoteTableMap::translateFieldName('Deliverydesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deliverydesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : QuoteTableMap::translateFieldName('Whse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : QuoteTableMap::translateFieldName('Custpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custpo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : QuoteTableMap::translateFieldName('Custref', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custref = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : QuoteTableMap::translateFieldName('Hasnotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasnotes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : QuoteTableMap::translateFieldName('Error', TableMap::TYPE_PHPNAME, $indexType)];
            $this->error = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : QuoteTableMap::translateFieldName('Errormsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->errormsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : QuoteTableMap::translateFieldName('Subtotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : QuoteTableMap::translateFieldName('Salestax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salestax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : QuoteTableMap::translateFieldName('Freight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : QuoteTableMap::translateFieldName('Misccost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->misccost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : QuoteTableMap::translateFieldName('Ordertotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordertotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : QuoteTableMap::translateFieldName('CostTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cost_total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : QuoteTableMap::translateFieldName('MarginAmt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->margin_amt = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : QuoteTableMap::translateFieldName('MarginPct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->margin_pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : QuoteTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 66; // 66 = QuoteTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(QuoteTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_RECNO)) {
            $modifiedColumns[':p' . $index++]  = 'recno';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_QUOTNBR)) {
            $modifiedColumns[':p' . $index++]  = 'quotnbr';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLNAME)) {
            $modifiedColumns[':p' . $index++]  = 'billname';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'billaddress';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'billaddress2';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLADDRESS3)) {
            $modifiedColumns[':p' . $index++]  = 'billaddress3';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLCOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'billcountry';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLCITY)) {
            $modifiedColumns[':p' . $index++]  = 'billcity';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLSTATE)) {
            $modifiedColumns[':p' . $index++]  = 'billstate';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLZIP)) {
            $modifiedColumns[':p' . $index++]  = 'billzip';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPTOID)) {
            $modifiedColumns[':p' . $index++]  = 'shiptoid';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPNAME)) {
            $modifiedColumns[':p' . $index++]  = 'shipname';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress2';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPADDRESS3)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress3';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPCOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'shipcountry';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPCITY)) {
            $modifiedColumns[':p' . $index++]  = 'shipcity';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPSTATE)) {
            $modifiedColumns[':p' . $index++]  = 'shipstate';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPZIP)) {
            $modifiedColumns[':p' . $index++]  = 'shipzip';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CONTACT)) {
            $modifiedColumns[':p' . $index++]  = 'contact';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_FAXNBR)) {
            $modifiedColumns[':p' . $index++]  = 'faxnbr';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CAREOF)) {
            $modifiedColumns[':p' . $index++]  = 'careof';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_QUOTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'quotdate';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_REVDATE)) {
            $modifiedColumns[':p' . $index++]  = 'revdate';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_EXPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'expdate';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_PRICECODE)) {
            $modifiedColumns[':p' . $index++]  = 'pricecode';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_PRICECODEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'pricecodedesc';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TAXCODE)) {
            $modifiedColumns[':p' . $index++]  = 'taxcode';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TAXCODEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'taxcodedesc';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TERMCODE)) {
            $modifiedColumns[':p' . $index++]  = 'termcode';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TERMCODEDESC)) {
            $modifiedColumns[':p' . $index++]  = 'termcodedesc';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPVIACD)) {
            $modifiedColumns[':p' . $index++]  = 'shipviacd';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPVIADESC)) {
            $modifiedColumns[':p' . $index++]  = 'shipviadesc';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP1)) {
            $modifiedColumns[':p' . $index++]  = 'sp1';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP1PCT)) {
            $modifiedColumns[':p' . $index++]  = 'sp1pct';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP1NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp1name';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP2)) {
            $modifiedColumns[':p' . $index++]  = 'sp2';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP2PCT)) {
            $modifiedColumns[':p' . $index++]  = 'sp2pct';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP2NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp2name';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP3)) {
            $modifiedColumns[':p' . $index++]  = 'sp3';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP3PCT)) {
            $modifiedColumns[':p' . $index++]  = 'sp3pct';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP3NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp3name';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_FOB)) {
            $modifiedColumns[':p' . $index++]  = 'fob';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_DELIVERYDESC)) {
            $modifiedColumns[':p' . $index++]  = 'deliverydesc';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'whse';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CUSTPO)) {
            $modifiedColumns[':p' . $index++]  = 'custpo';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CUSTREF)) {
            $modifiedColumns[':p' . $index++]  = 'custref';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_HASNOTES)) {
            $modifiedColumns[':p' . $index++]  = 'hasnotes';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_ERROR)) {
            $modifiedColumns[':p' . $index++]  = 'error';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_ERRORMSG)) {
            $modifiedColumns[':p' . $index++]  = 'errormsg';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SUBTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'subtotal';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SALESTAX)) {
            $modifiedColumns[':p' . $index++]  = 'salestax';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'freight';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_MISCCOST)) {
            $modifiedColumns[':p' . $index++]  = 'misccost';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_ORDERTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'ordertotal';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_COST_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'cost_total';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_MARGIN_AMT)) {
            $modifiedColumns[':p' . $index++]  = 'margin_amt';
        }
        if ($this->isColumnModified(QuoteTableMap::COL_MARGIN_PCT)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(QuoteTableMap::COL_SESSIONID)) {
            $criteria->add(QuoteTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_RECNO)) {
            $criteria->add(QuoteTableMap::COL_RECNO, $this->recno);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_DATE)) {
            $criteria->add(QuoteTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TIME)) {
            $criteria->add(QuoteTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_QUOTNBR)) {
            $criteria->add(QuoteTableMap::COL_QUOTNBR, $this->quotnbr);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_STATUS)) {
            $criteria->add(QuoteTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CUSTID)) {
            $criteria->add(QuoteTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLNAME)) {
            $criteria->add(QuoteTableMap::COL_BILLNAME, $this->billname);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLADDRESS)) {
            $criteria->add(QuoteTableMap::COL_BILLADDRESS, $this->billaddress);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLADDRESS2)) {
            $criteria->add(QuoteTableMap::COL_BILLADDRESS2, $this->billaddress2);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLADDRESS3)) {
            $criteria->add(QuoteTableMap::COL_BILLADDRESS3, $this->billaddress3);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLCOUNTRY)) {
            $criteria->add(QuoteTableMap::COL_BILLCOUNTRY, $this->billcountry);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLCITY)) {
            $criteria->add(QuoteTableMap::COL_BILLCITY, $this->billcity);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLSTATE)) {
            $criteria->add(QuoteTableMap::COL_BILLSTATE, $this->billstate);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_BILLZIP)) {
            $criteria->add(QuoteTableMap::COL_BILLZIP, $this->billzip);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPTOID)) {
            $criteria->add(QuoteTableMap::COL_SHIPTOID, $this->shiptoid);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPNAME)) {
            $criteria->add(QuoteTableMap::COL_SHIPNAME, $this->shipname);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPADDRESS)) {
            $criteria->add(QuoteTableMap::COL_SHIPADDRESS, $this->shipaddress);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPADDRESS2)) {
            $criteria->add(QuoteTableMap::COL_SHIPADDRESS2, $this->shipaddress2);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPADDRESS3)) {
            $criteria->add(QuoteTableMap::COL_SHIPADDRESS3, $this->shipaddress3);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPCOUNTRY)) {
            $criteria->add(QuoteTableMap::COL_SHIPCOUNTRY, $this->shipcountry);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPCITY)) {
            $criteria->add(QuoteTableMap::COL_SHIPCITY, $this->shipcity);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPSTATE)) {
            $criteria->add(QuoteTableMap::COL_SHIPSTATE, $this->shipstate);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPZIP)) {
            $criteria->add(QuoteTableMap::COL_SHIPZIP, $this->shipzip);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CONTACT)) {
            $criteria->add(QuoteTableMap::COL_CONTACT, $this->contact);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_PHONE)) {
            $criteria->add(QuoteTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_FAXNBR)) {
            $criteria->add(QuoteTableMap::COL_FAXNBR, $this->faxnbr);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_EMAIL)) {
            $criteria->add(QuoteTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CAREOF)) {
            $criteria->add(QuoteTableMap::COL_CAREOF, $this->careof);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_QUOTDATE)) {
            $criteria->add(QuoteTableMap::COL_QUOTDATE, $this->quotdate);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_REVDATE)) {
            $criteria->add(QuoteTableMap::COL_REVDATE, $this->revdate);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_EXPDATE)) {
            $criteria->add(QuoteTableMap::COL_EXPDATE, $this->expdate);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_PRICECODE)) {
            $criteria->add(QuoteTableMap::COL_PRICECODE, $this->pricecode);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_PRICECODEDESC)) {
            $criteria->add(QuoteTableMap::COL_PRICECODEDESC, $this->pricecodedesc);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TAXCODE)) {
            $criteria->add(QuoteTableMap::COL_TAXCODE, $this->taxcode);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TAXCODEDESC)) {
            $criteria->add(QuoteTableMap::COL_TAXCODEDESC, $this->taxcodedesc);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TERMCODE)) {
            $criteria->add(QuoteTableMap::COL_TERMCODE, $this->termcode);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_TERMCODEDESC)) {
            $criteria->add(QuoteTableMap::COL_TERMCODEDESC, $this->termcodedesc);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPVIACD)) {
            $criteria->add(QuoteTableMap::COL_SHIPVIACD, $this->shipviacd);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SHIPVIADESC)) {
            $criteria->add(QuoteTableMap::COL_SHIPVIADESC, $this->shipviadesc);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP1)) {
            $criteria->add(QuoteTableMap::COL_SP1, $this->sp1);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP1PCT)) {
            $criteria->add(QuoteTableMap::COL_SP1PCT, $this->sp1pct);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP1NAME)) {
            $criteria->add(QuoteTableMap::COL_SP1NAME, $this->sp1name);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP2)) {
            $criteria->add(QuoteTableMap::COL_SP2, $this->sp2);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP2PCT)) {
            $criteria->add(QuoteTableMap::COL_SP2PCT, $this->sp2pct);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP2NAME)) {
            $criteria->add(QuoteTableMap::COL_SP2NAME, $this->sp2name);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP3)) {
            $criteria->add(QuoteTableMap::COL_SP3, $this->sp3);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP3PCT)) {
            $criteria->add(QuoteTableMap::COL_SP3PCT, $this->sp3pct);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SP3NAME)) {
            $criteria->add(QuoteTableMap::COL_SP3NAME, $this->sp3name);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_FOB)) {
            $criteria->add(QuoteTableMap::COL_FOB, $this->fob);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_DELIVERYDESC)) {
            $criteria->add(QuoteTableMap::COL_DELIVERYDESC, $this->deliverydesc);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_WHSE)) {
            $criteria->add(QuoteTableMap::COL_WHSE, $this->whse);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CUSTPO)) {
            $criteria->add(QuoteTableMap::COL_CUSTPO, $this->custpo);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_CUSTREF)) {
            $criteria->add(QuoteTableMap::COL_CUSTREF, $this->custref);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_HASNOTES)) {
            $criteria->add(QuoteTableMap::COL_HASNOTES, $this->hasnotes);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_ERROR)) {
            $criteria->add(QuoteTableMap::COL_ERROR, $this->error);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_ERRORMSG)) {
            $criteria->add(QuoteTableMap::COL_ERRORMSG, $this->errormsg);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SUBTOTAL)) {
            $criteria->add(QuoteTableMap::COL_SUBTOTAL, $this->subtotal);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_SALESTAX)) {
            $criteria->add(QuoteTableMap::COL_SALESTAX, $this->salestax);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_FREIGHT)) {
            $criteria->add(QuoteTableMap::COL_FREIGHT, $this->freight);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_MISCCOST)) {
            $criteria->add(QuoteTableMap::COL_MISCCOST, $this->misccost);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_ORDERTOTAL)) {
            $criteria->add(QuoteTableMap::COL_ORDERTOTAL, $this->ordertotal);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_COST_TOTAL)) {
            $criteria->add(QuoteTableMap::COL_COST_TOTAL, $this->cost_total);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_MARGIN_AMT)) {
            $criteria->add(QuoteTableMap::COL_MARGIN_AMT, $this->margin_amt);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_MARGIN_PCT)) {
            $criteria->add(QuoteTableMap::COL_MARGIN_PCT, $this->margin_pct);
        }
        if ($this->isColumnModified(QuoteTableMap::COL_DUMMY)) {
