 ...
 */
abstract class CartQuote implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\CartQuoteTableMap';
    ...
    /**
     * Initializes internal state of Base\CartQuote object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>CartQuote</code> instance.  If
     * <code>obj</code> is an instance of <code>CartQuote</code>, delegates to
     * <code>equals(CartQuote)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|CartQuote The current object, for fluid interface
     */
     ...
     * @return $this|\CartQuote The current object (for fluent API support)
     */
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecno($v)
    {
        ...
        if ($this->recno !== $v) {
            $this->recno = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_RECNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_TIME] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CUSTID] = true;
        }
    ...
    public function setShiptoid($v)
    {
        ...
        if ($this->shiptoid !== $v) {
            $this->shiptoid = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPTOID] = true;
        }
    ...
    public function setCustname($v)
    {
        ...
        if ($this->custname !== $v) {
            $this->custname = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CUSTNAME] = true;
        }
    ...
    public function setOrderno($v)
    {
        ...
        if ($this->orderno !== $v) {
            $this->orderno = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_ORDERNO] = true;
        }
    ...
    public function setCustpo($v)
    {
        ...
        if ($this->custpo !== $v) {
            $this->custpo = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CUSTPO] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_STATUS] = true;
        }
    ...
    public function setOrderdate($v)
    {
        ...
        if ($this->orderdate !== $v) {
            $this->orderdate = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_ORDERDATE] = true;
        }
    ...
    public function setInvdate($v)
    {
        ...
        if ($this->invdate !== $v) {
            $this->invdate = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_INVDATE] = true;
        }
    ...
    public function setShipdate($v)
    {
        ...
        if ($this->shipdate !== $v) {
            $this->shipdate = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPDATE] = true;
        }
    ...
    public function setHasdocuments($v)
    {
        ...
        if ($this->hasdocuments !== $v) {
            $this->hasdocuments = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_HASDOCUMENTS] = true;
        }
    ...
    public function setHastracking($v)
    {
        ...
        if ($this->hastracking !== $v) {
            $this->hastracking = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_HASTRACKING] = true;
        }
    ...
    public function setSubtotal($v)
    {
        ...
        if ($this->subtotal !== $v) {
            $this->subtotal = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SUBTOTAL] = true;
        }
    ...
    public function setSalestax($v)
    {
        ...
        if ($this->salestax !== $v) {
            $this->salestax = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SALESTAX] = true;
        }
    ...
    public function setFreight($v)
    {
        ...
        if ($this->freight !== $v) {
            $this->freight = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_FREIGHT] = true;
        }
    ...
    public function setMisccost($v)
    {
        ...
        if ($this->misccost !== $v) {
            $this->misccost = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_MISCCOST] = true;
        }
    ...
    public function setOrdertotal($v)
    {
        ...
        if ($this->ordertotal !== $v) {
            $this->ordertotal = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_ORDERTOTAL] = true;
        }
    ...
    public function setHasnotes($v)
    {
        ...
        if ($this->hasnotes !== $v) {
            $this->hasnotes = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_HASNOTES] = true;
        }
    ...
    public function setEditord($v)
    {
        ...
        if ($this->editord !== $v) {
            $this->editord = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_EDITORD] = true;
        }
    ...
    public function setError($v)
    {
        ...
        if ($this->error !== $v) {
            $this->error = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_ERROR] = true;
        }
    ...
    public function setErrormsg($v)
    {
        ...
        if ($this->errormsg !== $v) {
            $this->errormsg = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_ERRORMSG] = true;
        }
    ...
    public function setSconame($v)
    {
        ...
        if ($this->sconame !== $v) {
            $this->sconame = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SCONAME] = true;
        }
    ...
    public function setShipname($v)
    {
        ...
        if ($this->shipname !== $v) {
            $this->shipname = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPNAME] = true;
        }
    ...
    public function setShipaddress($v)
    {
        ...
        if ($this->shipaddress !== $v) {
            $this->shipaddress = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPADDRESS] = true;
        }
    ...
    public function setShipaddress2($v)
    {
        ...
        if ($this->shipaddress2 !== $v) {
            $this->shipaddress2 = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPADDRESS2] = true;
        }
    ...
    public function setShipcity($v)
    {
        ...
        if ($this->shipcity !== $v) {
            $this->shipcity = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPCITY] = true;
        }
    ...
    public function setShipstate($v)
    {
        ...
        if ($this->shipstate !== $v) {
            $this->shipstate = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPSTATE] = true;
        }
    ...
    public function setShipzip($v)
    {
        ...
        if ($this->shipzip !== $v) {
            $this->shipzip = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPZIP] = true;
        }
    ...
    public function setShipcountry($v)
    {
        ...
        if ($this->shipcountry !== $v) {
            $this->shipcountry = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPCOUNTRY] = true;
        }
    ...
    public function setContact($v)
    {
        ...
        if ($this->contact !== $v) {
            $this->contact = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CONTACT] = true;
        }
    ...
    public function setPhintl($v)
    {
        ...
        if ($this->phintl !== $v) {
            $this->phintl = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_PHINTL] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_PHONE] = true;
        }
    ...
    public function setExtension($v)
    {
        ...
        if ($this->extension !== $v) {
            $this->extension = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_EXTENSION] = true;
        }
    ...
    public function setFaxnbr($v)
    {
        ...
        if ($this->faxnbr !== $v) {
            $this->faxnbr = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_FAXNBR] = true;
        }
    ...
    public function setEmail($v)
    {
        ...
        if ($this->email !== $v) {
            $this->email = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_EMAIL] = true;
        }
    ...
    public function setReleasenbr($v)
    {
        ...
        if ($this->releasenbr !== $v) {
            $this->releasenbr = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_RELEASENBR] = true;
        }
    ...
    public function setShipviacd($v)
    {
        ...
        if ($this->shipviacd !== $v) {
            $this->shipviacd = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPVIACD] = true;
        }
    ...
    public function setShipviadesc($v)
    {
        ...
        if ($this->shipviadesc !== $v) {
            $this->shipviadesc = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPVIADESC] = true;
        }
    ...
    public function setTermcode($v)
    {
        ...
        if ($this->termcode !== $v) {
            $this->termcode = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_TERMCODE] = true;
        }
    ...
    public function setTermtype($v)
    {
        ...
        if ($this->termtype !== $v) {
            $this->termtype = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_TERMTYPE] = true;
        }
    ...
    public function setTermdesc($v)
    {
        ...
        if ($this->termdesc !== $v) {
            $this->termdesc = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_TERMDESC] = true;
        }
    ...
    public function setRqstdate($v)
    {
        ...
        if ($this->rqstdate !== $v) {
            $this->rqstdate = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_RQSTDATE] = true;
        }
    ...
    public function setShipcom($v)
    {
        ...
        if ($this->shipcom !== $v) {
            $this->shipcom = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SHIPCOM] = true;
        }
    ...
    public function setSp1($v)
    {
        ...
        if ($this->sp1 !== $v) {
            $this->sp1 = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SP1] = true;
        }
    ...
    public function setSp1name($v)
    {
        ...
        if ($this->sp1name !== $v) {
            $this->sp1name = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SP1NAME] = true;
        }
    ...
    public function setCardnumber($v)
    {
        ...
        if ($this->cardnumber !== $v) {
            $this->cardnumber = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CARDNUMBER] = true;
        }
    ...
    public function setCardexpire($v)
    {
        ...
        if ($this->cardexpire !== $v) {
            $this->cardexpire = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CARDEXPIRE] = true;
        }
    ...
    public function setCardcode($v)
    {
        ...
        if ($this->cardcode !== $v) {
            $this->cardcode = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CARDCODE] = true;
        }
    ...
    public function setCardapproval($v)
    {
        ...
        if ($this->cardapproval !== $v) {
            $this->cardapproval = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_CARDAPPROVAL] = true;
        }
    ...
    public function setTotalcost($v)
    {
        ...
        if ($this->totalcost !== $v) {
            $this->totalcost = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_TOTALCOST] = true;
        }
    ...
    public function setTotaldiscount($v)
    {
        ...
        if ($this->totaldiscount !== $v) {
            ...
            $this->modifiedColumns[CartQuoteTableMap::COL_TOTALDISCOUNT] = true;
        }
    ...
    public function setPaymenttype($v)
    {
        ...
        if ($this->paymenttype !== $v) {
            $this->paymenttype = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_PAYMENTTYPE] = true;
        }
    ...
    public function setSrcdatefrom($v)
    {
        ...
        if ($this->srcdatefrom !== $v) {
            $this->srcdatefrom = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SRCDATEFROM] = true;
        }
    ...
    public function setSrcdatethru($v)
    {
        ...
        if ($this->srcdatethru !== $v) {
            $this->srcdatethru = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_SRCDATETHRU] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[CartQuoteTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CartQuoteTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CartQuoteTableMap::translateFieldName('Recno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CartQuoteTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CartQuoteTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CartQuoteTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CartQuoteTableMap::translateFieldName('Shiptoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shiptoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : CartQuoteTableMap::translateFieldName('Custname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : CartQuoteTableMap::translateFieldName('Orderno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : CartQuoteTableMap::translateFieldName('Custpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custpo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : CartQuoteTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : CartQuoteTableMap::translateFieldName('Orderdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : CartQuoteTableMap::translateFieldName('Invdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : CartQuoteTableMap::translateFieldName('Shipdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : CartQuoteTableMap::translateFieldName('Hasdocuments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasdocuments = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : CartQuoteTableMap::translateFieldName('Hastracking', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hastracking = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : CartQuoteTableMap::translateFieldName('Subtotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : CartQuoteTableMap::translateFieldName('Salestax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salestax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : CartQuoteTableMap::translateFieldName('Freight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : CartQuoteTableMap::translateFieldName('Misccost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->misccost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : CartQuoteTableMap::translateFieldName('Ordertotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordertotal = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : CartQuoteTableMap::translateFieldName('Hasnotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->hasnotes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : CartQuoteTableMap::translateFieldName('Editord', TableMap::TYPE_PHPNAME, $indexType)];
            $this->editord = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : CartQuoteTableMap::translateFieldName('Error', TableMap::TYPE_PHPNAME, $indexType)];
            $this->error = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : CartQuoteTableMap::translateFieldName('Errormsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->errormsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : CartQuoteTableMap::translateFieldName('Sconame', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sconame = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : CartQuoteTableMap::translateFieldName('Shipname', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipname = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : CartQuoteTableMap::translateFieldName('Shipaddress', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : CartQuoteTableMap::translateFieldName('Shipaddress2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipaddress2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : CartQuoteTableMap::translateFieldName('Shipcity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : CartQuoteTableMap::translateFieldName('Shipstate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipstate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : CartQuoteTableMap::translateFieldName('Shipzip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipzip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : CartQuoteTableMap::translateFieldName('Shipcountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcountry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : CartQuoteTableMap::translateFieldName('Contact', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : CartQuoteTableMap::translateFieldName('Phintl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phintl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : CartQuoteTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : CartQuoteTableMap::translateFieldName('Extension', TableMap::TYPE_PHPNAME, $indexType)];
            $this->extension = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : CartQuoteTableMap::translateFieldName('Faxnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->faxnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : CartQuoteTableMap::translateFieldName('Email', TableMap::TYPE_PHPNAME, $indexType)];
            $this->email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : CartQuoteTableMap::translateFieldName('Releasenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->releasenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : CartQuoteTableMap::translateFieldName('Shipviacd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviacd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : CartQuoteTableMap::translateFieldName('Shipviadesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviadesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : CartQuoteTableMap::translateFieldName('Termcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : CartQuoteTableMap::translateFieldName('Termtype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termtype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : CartQuoteTableMap::translateFieldName('Termdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : CartQuoteTableMap::translateFieldName('Rqstdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->rqstdate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : CartQuoteTableMap::translateFieldName('Shipcom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : CartQuoteTableMap::translateFieldName('Sp1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : CartQuoteTableMap::translateFieldName('Sp1name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sp1name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : CartQuoteTableMap::translateFieldName('Cardnumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardnumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : CartQuoteTableMap::translateFieldName('Cardexpire', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardexpire = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : CartQuoteTableMap::translateFieldName('Cardcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : CartQuoteTableMap::translateFieldName('Cardapproval', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cardapproval = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : CartQuoteTableMap::translateFieldName('Totalcost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totalcost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : CartQuoteTableMap::translateFieldName('Totaldiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->totaldiscount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : CartQuoteTableMap::translateFieldName('Paymenttype', TableMap::TYPE_PHPNAME, $indexType)];
            $this->paymenttype = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : CartQuoteTableMap::translateFieldName('Srcdatefrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->srcdatefrom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : CartQuoteTableMap::translateFieldName('Srcdatethru', TableMap::TYPE_PHPNAME, $indexType)];
            $this->srcdatethru = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : CartQuoteTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 58; // 58 = CartQuoteTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\CartQuote'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildCartQuoteQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see CartQuote::setDeleted()
     * @see CartQuote::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildCartQuoteQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                CartQuoteTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CartQuoteTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_RECNO)) {
            $modifiedColumns[':p' . $index++]  = 'recno';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPTOID)) {
            $modifiedColumns[':p' . $index++]  = 'shiptoid';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CUSTNAME)) {
            $modifiedColumns[':p' . $index++]  = 'custname';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ORDERNO)) {
            $modifiedColumns[':p' . $index++]  = 'orderno';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CUSTPO)) {
            $modifiedColumns[':p' . $index++]  = 'custpo';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ORDERDATE)) {
            $modifiedColumns[':p' . $index++]  = 'orderdate';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_INVDATE)) {
            $modifiedColumns[':p' . $index++]  = 'invdate';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPDATE)) {
            $modifiedColumns[':p' . $index++]  = 'shipdate';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_HASDOCUMENTS)) {
            $modifiedColumns[':p' . $index++]  = 'hasdocuments';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_HASTRACKING)) {
            $modifiedColumns[':p' . $index++]  = 'hastracking';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SUBTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'subtotal';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SALESTAX)) {
            $modifiedColumns[':p' . $index++]  = 'salestax';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'freight';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_MISCCOST)) {
            $modifiedColumns[':p' . $index++]  = 'misccost';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ORDERTOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'ordertotal';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_HASNOTES)) {
            $modifiedColumns[':p' . $index++]  = 'hasnotes';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_EDITORD)) {
            $modifiedColumns[':p' . $index++]  = 'editord';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ERROR)) {
            $modifiedColumns[':p' . $index++]  = 'error';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ERRORMSG)) {
            $modifiedColumns[':p' . $index++]  = 'errormsg';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SCONAME)) {
            $modifiedColumns[':p' . $index++]  = 'sconame';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPNAME)) {
            $modifiedColumns[':p' . $index++]  = 'shipname';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPADDRESS)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'shipaddress2';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPCITY)) {
            $modifiedColumns[':p' . $index++]  = 'shipcity';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPSTATE)) {
            $modifiedColumns[':p' . $index++]  = 'shipstate';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPZIP)) {
            $modifiedColumns[':p' . $index++]  = 'shipzip';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPCOUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'shipcountry';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CONTACT)) {
            $modifiedColumns[':p' . $index++]  = 'contact';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_PHINTL)) {
            $modifiedColumns[':p' . $index++]  = 'phintl';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_EXTENSION)) {
            $modifiedColumns[':p' . $index++]  = 'extension';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_FAXNBR)) {
            $modifiedColumns[':p' . $index++]  = 'faxnbr';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'email';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_RELEASENBR)) {
            $modifiedColumns[':p' . $index++]  = 'releasenbr';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPVIACD)) {
            $modifiedColumns[':p' . $index++]  = 'shipviacd';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPVIADESC)) {
            $modifiedColumns[':p' . $index++]  = 'shipviadesc';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TERMCODE)) {
            $modifiedColumns[':p' . $index++]  = 'termcode';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TERMTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'termtype';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TERMDESC)) {
            $modifiedColumns[':p' . $index++]  = 'termdesc';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_RQSTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'rqstdate';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPCOM)) {
            $modifiedColumns[':p' . $index++]  = 'shipcom';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SP1)) {
            $modifiedColumns[':p' . $index++]  = 'sp1';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SP1NAME)) {
            $modifiedColumns[':p' . $index++]  = 'sp1name';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'cardnumber';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDEXPIRE)) {
            $modifiedColumns[':p' . $index++]  = 'cardexpire';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDCODE)) {
            $modifiedColumns[':p' . $index++]  = 'cardcode';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDAPPROVAL)) {
            $modifiedColumns[':p' . $index++]  = 'cardapproval';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TOTALCOST)) {
            $modifiedColumns[':p' . $index++]  = 'totalcost';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TOTALDISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'totaldiscount';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_PAYMENTTYPE)) {
            $modifiedColumns[':p' . $index++]  = 'paymenttype';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SRCDATEFROM)) {
            $modifiedColumns[':p' . $index++]  = 'srcdatefrom';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SRCDATETHRU)) {
            $modifiedColumns[':p' . $index++]  = 'srcdatethru';
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_DUMMY)) {
    ...
    {
        $pos = CartQuoteTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['CartQuote'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['CartQuote'][$this->hashCode()] = true;
        $keys = CartQuoteTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CartQuoteTableMap::COL_SESSIONID)) {
            $criteria->add(CartQuoteTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_RECNO)) {
            $criteria->add(CartQuoteTableMap::COL_RECNO, $this->recno);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_DATE)) {
            $criteria->add(CartQuoteTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TIME)) {
            $criteria->add(CartQuoteTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CUSTID)) {
            $criteria->add(CartQuoteTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPTOID)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPTOID, $this->shiptoid);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CUSTNAME)) {
            $criteria->add(CartQuoteTableMap::COL_CUSTNAME, $this->custname);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ORDERNO)) {
            $criteria->add(CartQuoteTableMap::COL_ORDERNO, $this->orderno);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CUSTPO)) {
            $criteria->add(CartQuoteTableMap::COL_CUSTPO, $this->custpo);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_STATUS)) {
            $criteria->add(CartQuoteTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ORDERDATE)) {
            $criteria->add(CartQuoteTableMap::COL_ORDERDATE, $this->orderdate);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_INVDATE)) {
            $criteria->add(CartQuoteTableMap::COL_INVDATE, $this->invdate);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPDATE)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPDATE, $this->shipdate);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_HASDOCUMENTS)) {
            $criteria->add(CartQuoteTableMap::COL_HASDOCUMENTS, $this->hasdocuments);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_HASTRACKING)) {
            $criteria->add(CartQuoteTableMap::COL_HASTRACKING, $this->hastracking);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SUBTOTAL)) {
            $criteria->add(CartQuoteTableMap::COL_SUBTOTAL, $this->subtotal);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SALESTAX)) {
            $criteria->add(CartQuoteTableMap::COL_SALESTAX, $this->salestax);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_FREIGHT)) {
            $criteria->add(CartQuoteTableMap::COL_FREIGHT, $this->freight);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_MISCCOST)) {
            $criteria->add(CartQuoteTableMap::COL_MISCCOST, $this->misccost);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ORDERTOTAL)) {
            $criteria->add(CartQuoteTableMap::COL_ORDERTOTAL, $this->ordertotal);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_HASNOTES)) {
            $criteria->add(CartQuoteTableMap::COL_HASNOTES, $this->hasnotes);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_EDITORD)) {
            $criteria->add(CartQuoteTableMap::COL_EDITORD, $this->editord);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ERROR)) {
            $criteria->add(CartQuoteTableMap::COL_ERROR, $this->error);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_ERRORMSG)) {
            $criteria->add(CartQuoteTableMap::COL_ERRORMSG, $this->errormsg);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SCONAME)) {
            $criteria->add(CartQuoteTableMap::COL_SCONAME, $this->sconame);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPNAME)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPNAME, $this->shipname);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPADDRESS)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPADDRESS, $this->shipaddress);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPADDRESS2)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPADDRESS2, $this->shipaddress2);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPCITY)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPCITY, $this->shipcity);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPSTATE)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPSTATE, $this->shipstate);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPZIP)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPZIP, $this->shipzip);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPCOUNTRY)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPCOUNTRY, $this->shipcountry);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CONTACT)) {
            $criteria->add(CartQuoteTableMap::COL_CONTACT, $this->contact);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_PHINTL)) {
            $criteria->add(CartQuoteTableMap::COL_PHINTL, $this->phintl);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_PHONE)) {
            $criteria->add(CartQuoteTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_EXTENSION)) {
            $criteria->add(CartQuoteTableMap::COL_EXTENSION, $this->extension);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_FAXNBR)) {
            $criteria->add(CartQuoteTableMap::COL_FAXNBR, $this->faxnbr);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_EMAIL)) {
            $criteria->add(CartQuoteTableMap::COL_EMAIL, $this->email);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_RELEASENBR)) {
            $criteria->add(CartQuoteTableMap::COL_RELEASENBR, $this->releasenbr);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPVIACD)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPVIACD, $this->shipviacd);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPVIADESC)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPVIADESC, $this->shipviadesc);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TERMCODE)) {
            $criteria->add(CartQuoteTableMap::COL_TERMCODE, $this->termcode);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TERMTYPE)) {
            $criteria->add(CartQuoteTableMap::COL_TERMTYPE, $this->termtype);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TERMDESC)) {
            $criteria->add(CartQuoteTableMap::COL_TERMDESC, $this->termdesc);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_RQSTDATE)) {
            $criteria->add(CartQuoteTableMap::COL_RQSTDATE, $this->rqstdate);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SHIPCOM)) {
            $criteria->add(CartQuoteTableMap::COL_SHIPCOM, $this->shipcom);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SP1)) {
            $criteria->add(CartQuoteTableMap::COL_SP1, $this->sp1);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SP1NAME)) {
            $criteria->add(CartQuoteTableMap::COL_SP1NAME, $this->sp1name);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDNUMBER)) {
            $criteria->add(CartQuoteTableMap::COL_CARDNUMBER, $this->cardnumber);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDEXPIRE)) {
            $criteria->add(CartQuoteTableMap::COL_CARDEXPIRE, $this->cardexpire);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDCODE)) {
            $criteria->add(CartQuoteTableMap::COL_CARDCODE, $this->cardcode);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_CARDAPPROVAL)) {
            $criteria->add(CartQuoteTableMap::COL_CARDAPPROVAL, $this->cardapproval);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TOTALCOST)) {
            $criteria->add(CartQuoteTableMap::COL_TOTALCOST, $this->totalcost);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_TOTALDISCOUNT)) {
            $criteria->add(CartQuoteTableMap::COL_TOTALDISCOUNT, $this->totaldiscount);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_PAYMENTTYPE)) {
            $criteria->add(CartQuoteTableMap::COL_PAYMENTTYPE, $this->paymenttype);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SRCDATEFROM)) {
            $criteria->add(CartQuoteTableMap::COL_SRCDATEFROM, $this->srcdatefrom);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_SRCDATETHRU)) {
            $criteria->add(CartQuoteTableMap::COL_SRCDATETHRU, $this->srcdatethru);
        }
        if ($this->isColumnModified(CartQuoteTableMap::COL_DUMMY)) {
            $criteria->add(CartQuoteTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildCartQuoteQuery::create();
        $criteria->add(CartQuoteTableMap::COL_SESSIONID, $this->sessionid);
        $criteria->add(CartQuoteTableMap::COL_RECNO, $this->recno);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \CartQuote (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \CartQuote Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(CartQuoteTableMap::DEFAULT_STRING_FORMAT);
    }
